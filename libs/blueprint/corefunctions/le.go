...
// LeFunction provides the implementation of
// a function that checks if a number is greater than or equal to another.
type LeFunction struct {
	definition *function.Definition
}

// NewLeFunction creates a new instance of the LeFunction with
// a complete function definition.
func NewLeFunction() provider.Function {
	return &LeFunction{
		definition: &function.Definition{
			Description: "A function that determines whether a number is less than or equal to another number.",
			FormattedDescription: "A function that determines whether a number is less than or equal to another number.\n\n" +
				"**Examples:**\n\n" +
			...
			Return: &function.ScalarReturn{
				...
				Description: "True, if the first number is less than or equal to the second number, false otherwise.",
			},
		},
	}
}

func (f *LeFunction) GetDefinition(
	ctx context.Context,
