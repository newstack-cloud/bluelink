...
func TestProviderErrorsWithContext(t *testing.T) {
	t.Run("DataSourceTypeProviderNotFound", func(t *testing.T) {
		...
		assert.Equal(t, errors.ErrorCategoryProvider, runErr.Context.Category)
	...
	t.Run("ProviderDataSourceTypeNotFound", func(t *testing.T) {
		...
		assert.True(t, ok)
		assert.NotNil(t, runErr.Context)
		assert.Equal(t, errors.ErrorCategoryDataSourceType, runErr.Context.Category)
	...
	t.Run("FunctionNotFound", func(t *testing.T) {
		...
		assert.True(t, ok)
		assert.NotNil(t, runErr.Context)
		assert.Equal(t, errors.ErrorCategoryFunction, runErr.Context.Category)
