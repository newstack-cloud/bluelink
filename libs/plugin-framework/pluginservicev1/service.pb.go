...
// ReleaseResourceLockRequest is the request
// to release a lock on a resource.
type ReleaseResourceLockRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The ID of the blueprint instance the lock is scoped to.
	InstanceId string `protobuf:"bytes,1,opt,name=instance_id,json=instanceId" json:"instance_id,omitempty"`
	// The name of the resource in the blueprint to release.
	ResourceName string `protobuf:"bytes,2,opt,name=resource_name,json=resourceName" json:"resource_name,omitempty"`
	// The identifier of the caller that holds the lock. A lock recorded under any
	// other caller is left alone.
	AcquiredBy    string                         `protobuf:"bytes,3,opt,name=acquired_by,json=acquiredBy" json:"acquired_by,omitempty"`
	Context       *sharedtypesv1.ProviderContext `protobuf:"bytes,4,opt,name=context" json:"context,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *ReleaseResourceLockRequest) Reset() {
	*x = ReleaseResourceLockRequest{}
	mi := &file_plugin_framework_pluginservicev1_service_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ReleaseResourceLockRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReleaseResourceLockRequest) ProtoMessage() {}

func (x *ReleaseResourceLockRequest) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_framework_pluginservicev1_service_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReleaseResourceLockRequest.ProtoReflect.Descriptor instead.
func (*ReleaseResourceLockRequest) Descriptor() ([]byte, []int) {
	return file_plugin_framework_pluginservicev1_service_proto_rawDescGZIP(), []int{16}
}

func (x *ReleaseResourceLockRequest) GetInstanceId() string {
	if x != nil {
		return x.InstanceId
	}
	return ""
...
func (x *ReleaseResourceLockRequest) GetResourceName() string {
	if x != nil {
		return x.ResourceName
	}
	return ""
...
func (x *ReleaseResourceLockRequest) GetAcquiredBy() string {
	if x != nil {
		return x.AcquiredBy
	}
	return ""
...
func (x *ReleaseResourceLockRequest) GetContext() *sharedtypesv1.ProviderContext {
	if x != nil {
		return x.Context
	}
	return nil
...
// ReleaseResourceLockResponse is the response
// containing the result of releasing a resource lock.
type ReleaseResourceLockResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Response:
	//
	//	*ReleaseResourceLockResponse_Result
	//	*ReleaseResourceLockResponse_ErrorResponse
	Response      isReleaseResourceLockResponse_Response `protobuf_oneof:"response"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ReleaseResourceLockResponse) Reset() {
	*x = ReleaseResourceLockResponse{}
	mi := &file_plugin_framework_pluginservicev1_service_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ReleaseResourceLockResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReleaseResourceLockResponse) ProtoMessage() {}

func (x *ReleaseResourceLockResponse) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_framework_pluginservicev1_service_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReleaseResourceLockResponse.ProtoReflect.Descriptor instead.
func (*ReleaseResourceLockResponse) Descriptor() ([]byte, []int) {
	return file_plugin_framework_pluginservicev1_service_proto_rawDescGZIP(), []int{17}
}

func (x *ReleaseResourceLockResponse) GetResponse() isReleaseResourceLockResponse_Response {
	if x != nil {
		return x.Response
	}
	return nil
...
func (x *ReleaseResourceLockResponse) GetResult() *ReleaseResourceLockResult {
	if x != nil {
		if x, ok := x.Response.(*ReleaseResourceLockResponse_Result); ok {
			return x.Result
		}
	}
	return nil
...
func (x *ReleaseResourceLockResponse) GetErrorResponse() *sharedtypesv1.ErrorResponse {
	if x != nil {
		if x, ok := x.Response.(*ReleaseResourceLockResponse_ErrorResponse); ok {
			return x.ErrorResponse
		}
	}
	return nil
...
type isReleaseResourceLockResponse_Response interface {
	isReleaseResourceLockResponse_Response()
}

type ReleaseResourceLockResponse_Result struct {
	Result *ReleaseResourceLockResult `protobuf:"bytes,1,opt,name=result,oneof"`
}

type ReleaseResourceLockResponse_ErrorResponse struct {
	ErrorResponse *sharedtypesv1.ErrorResponse `protobuf:"bytes,2,opt,name=error_response,json=errorResponse,oneof"`
}

func (*ReleaseResourceLockResponse_Result) isReleaseResourceLockResponse_Response() {}

func (*ReleaseResourceLockResponse_ErrorResponse) isReleaseResourceLockResponse_Response() {}

// ReleaseResourceLockResult contains the result
// of releasing a lock on a resource.
type ReleaseResourceLockResult struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Whether a lock held by the caller was released. False when there was
	// nothing to release, which is not a failure.
	Released      bool `protobuf:"varint,1,opt,name=released" json:"released,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ReleaseResourceLockResult) Reset() {
	*x = ReleaseResourceLockResult{}
	mi := &file_plugin_framework_pluginservicev1_service_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ReleaseResourceLockResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReleaseResourceLockResult) ProtoMessage() {}

func (x *ReleaseResourceLockResult) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_framework_pluginservicev1_service_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReleaseResourceLockResult.ProtoReflect.Descriptor instead.
func (*ReleaseResourceLockResult) Descriptor() ([]byte, []int) {
	return file_plugin_framework_pluginservicev1_service_proto_rawDescGZIP(), []int{18}
}

func (x *ReleaseResourceLockResult) GetReleased() bool {
	if x != nil {
		return x.Released
	}
	return false
...
var file_plugin_framework_pluginservicev1_service_proto_rawDesc = string([]byte{
	...
	0x01, 0x28, 0x08, 0x52, 0x08, 0x61, 0x63, 0x71, 0x75, 0x69, 0x72, 0x65, 0x64, 0x22, 0xbd, 0x01,
	0x0a, 0x1a, 0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x4c, 0x6f, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1f, 0x0a, 0x0b,
	...
	0x6d, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x61, 0x63, 0x71, 0x75, 0x69, 0x72, 0x65, 0x64, 0x5f, 0x62,
	0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x61, 0x63, 0x71, 0x75, 0x69, 0x72, 0x65,
	0x64, 0x42, 0x79, 0x12, 0x38, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x18, 0x04,
	...
	0x0a, 0x1b, 0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x4c, 0x6f, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x44, 0x0a,
	0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e,
	0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x76, 0x31, 0x2e,
	0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x4c,
	0x6f, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x48, 0x00, 0x52, 0x06, 0x72, 0x65, 0x73,
	0x75, 0x6c, 0x74, 0x12, 0x45, 0x0a, 0x0e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x5f, 0x72, 0x65, 0x73,
	...
	,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x59, 0x0a, 0x0c, 0x43, 0x61,
	0x6c, 0x6c, 0x46, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x22, 0x2e, 0x73, 0x68, 0x61,
	0x72, 0x65, 0x64, 0x74, 0x79, 0x70, 0x65, 0x73, 0x76, 0x31, 0x2e, 0x46, 0x75, 0x6e, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x43, 0x61, 0x6c, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x23,
	...
	,
	...
	0x75, 0x72, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x62,
	...
	,
	...
	0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x2d, 0x66, 0x72, 0x61, 0x6d, 0x65, 0x77, 0x6f, 0x72, 0x6b,
	0x2f, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x76, 0x31,
...
var file_plugin_framework_pluginservicev1_service_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_plugin_framework_pluginservicev1_service_proto_goTypes = []any{
	...
	(*ReleaseResourceLockRequest)(nil),               // 17: pluginservicev1.ReleaseResourceLockRequest
	(*ReleaseResourceLockResponse)(nil),              // 18: pluginservicev1.ReleaseResourceLockResponse
	(*ReleaseResourceLockResult)(nil),                // 19: pluginservicev1.ReleaseResourceLockResult
	(*sharedtypesv1.ErrorResponse)(nil),              // 20: sharedtypesv1.ErrorResponse
	(*sharedtypesv1.DeployResourceRequest)(nil),      // 21: sharedtypesv1.DeployResourceRequest
	(*sharedtypesv1.ProviderContext)(nil),            // 22: sharedtypesv1.ProviderContext
	(*sharedtypesv1.ResourceState)(nil),              // 23: sharedtypesv1.ResourceState
	(*sharedtypesv1.FunctionCallRequest)(nil),        // 24: sharedtypesv1.FunctionCallRequest
	(*sharedtypesv1.FunctionDefinitionRequest)(nil),  // 25: sharedtypesv1.FunctionDefinitionRequest
	(*emptypb.Empty)(nil),                            // 26: google.protobuf.Empty
	(*sharedtypesv1.DestroyResourceRequest)(nil),     // 27: sharedtypesv1.DestroyResourceRequest
	(*sharedtypesv1.FunctionCallResponse)(nil),       // 28: sharedtypesv1.FunctionCallResponse
	(*sharedtypesv1.FunctionDefinitionResponse)(nil), // 29: sharedtypesv1.FunctionDefinitionResponse
	(*sharedtypesv1.DeployResourceResponse)(nil),     // 30: sharedtypesv1.DeployResourceResponse
	(*sharedtypesv1.DestroyResourceResponse)(nil),    // 31: sharedtypesv1.DestroyResourceResponse
}
var file_plugin_framework_pluginservicev1_service_proto_depIdxs = []int32{
	...
	20, // 4: pluginservicev1.HasFunctionResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	10, // 5: pluginservicev1.ListFunctionsResponse.function_list:type_name -> pluginservicev1.FunctionList
	20, // 6: pluginservicev1.ListFunctionsResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	21, // 7: pluginservicev1.DeployResourceServiceRequest.deploy_request:type_name -> sharedtypesv1.DeployResourceRequest
	22, // 8: pluginservicev1.LookupResourceInStateRequest.context:type_name -> sharedtypesv1.ProviderContext
	23, // 9: pluginservicev1.LookupResourceInStateResponse.resource:type_name -> sharedtypesv1.ResourceState
	20, // 10: pluginservicev1.LookupResourceInStateResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	22, // 11: pluginservicev1.AcquireResourceLockRequest.context:type_name -> sharedtypesv1.ProviderContext
	16, // 12: pluginservicev1.AcquireResourceLockResponse.result:type_name -> pluginservicev1.AcquireResourceLockResult
	20, // 13: pluginservicev1.AcquireResourceLockResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	22, // 14: pluginservicev1.ReleaseResourceLockRequest.context:type_name -> sharedtypesv1.ProviderContext
	19, // 15: pluginservicev1.ReleaseResourceLockResponse.result:type_name -> pluginservicev1.ReleaseResourceLockResult
	20, // 16: pluginservicev1.ReleaseResourceLockResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	1,  // 17: pluginservicev1.Service.Register:input_type -> pluginservicev1.PluginRegistrationRequest
	4,  // 18: pluginservicev1.Service.Deregister:input_type -> pluginservicev1.PluginDeregistrationRequest
	24, // 19: pluginservicev1.Service.CallFunction:input_type -> sharedtypesv1.FunctionCallRequest
	25, // 20: pluginservicev1.Service.GetFunctionDefinition:input_type -> sharedtypesv1.FunctionDefinitionRequest
	6,  // 21: pluginservicev1.Service.HasFunction:input_type -> pluginservicev1.HasFunctionRequest
	26, // 22: pluginservicev1.Service.ListFunctions:input_type -> google.protobuf.Empty
	11, // 23: pluginservicev1.Service.DeployResource:input_type -> pluginservicev1.DeployResourceServiceRequest
	27, // 24: pluginservicev1.Service.DestroyResource:input_type -> sharedtypesv1.DestroyResourceRequest
	12, // 25: pluginservicev1.Service.LookupResourceInState:input_type -> pluginservicev1.LookupResourceInStateRequest
	14, // 26: pluginservicev1.Service.AcquireResourceLock:input_type -> pluginservicev1.AcquireResourceLockRequest
	17, // 27: pluginservicev1.Service.ReleaseResourceLock:input_type -> pluginservicev1.ReleaseResourceLockRequest
	3,  // 28: pluginservicev1.Service.Register:output_type -> pluginservicev1.PluginRegistrationResponse
	5,  // 29: pluginservicev1.Service.Deregister:output_type -> pluginservicev1.PluginDeregistrationResponse
	28, // 30: pluginservicev1.Service.CallFunction:output_type -> sharedtypesv1.FunctionCallResponse
	29, // 31: pluginservicev1.Service.GetFunctionDefinition:output_type -> sharedtypesv1.FunctionDefinitionResponse
	7,  // 32: pluginservicev1.Service.HasFunction:output_type -> pluginservicev1.HasFunctionResponse
	9,  // 33: pluginservicev1.Service.ListFunctions:output_type -> pluginservicev1.ListFunctionsResponse
	30, // 34: pluginservicev1.Service.DeployResource:output_type -> sharedtypesv1.DeployResourceResponse
	31, // 35: pluginservicev1.Service.DestroyResource:output_type -> sharedtypesv1.DestroyResourceResponse
	13, // 36: pluginservicev1.Service.LookupResourceInState:output_type -> pluginservicev1.LookupResourceInStateResponse
	15, // 37: pluginservicev1.Service.AcquireResourceLock:output_type -> pluginservicev1.AcquireResourceLockResponse
	18, // 38: pluginservicev1.Service.ReleaseResourceLock:output_type -> pluginservicev1.ReleaseResourceLockResponse
...
func file_plugin_framework_pluginservicev1_service_proto_init() {
	...
	file_plugin_framework_pluginservicev1_service_proto_msgTypes[17].OneofWrappers = []any{
		(*ReleaseResourceLockResponse_Result)(nil),
		(*ReleaseResourceLockResponse_ErrorResponse)(nil),
	}
	type x struct{}
