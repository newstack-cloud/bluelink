...
// ContributionAction determines how a contribution is combined with what is already at
// the field path it targets.
type ContributionAction int32

const (
	// Replaces the value at the field path.
	ContributionAction_CONTRIBUTION_ACTION_SET ContributionAction = 0
	// Adds the value to the end of the list at the field path.
	ContributionAction_CONTRIBUTION_ACTION_APPEND ContributionAction = 1
)

// Enum value maps for ContributionAction.
var (
	ContributionAction_name = map[int32]string{
		0: "CONTRIBUTION_ACTION_SET",
		1: "CONTRIBUTION_ACTION_APPEND",
	}
	ContributionAction_value = map[string]int32{
		"CONTRIBUTION_ACTION_SET":    0,
		"CONTRIBUTION_ACTION_APPEND": 1,
	}
)

func (x ContributionAction) Enum() *ContributionAction {
	p := new(ContributionAction)
	*p = x
	return p
}

func (x ContributionAction) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ContributionAction) Descriptor() protoreflect.EnumDescriptor {
	return file_plugin_framework_providerserverv1_provider_proto_enumTypes[0].Descriptor()
}

func (ContributionAction) Type() protoreflect.EnumType {
	return &file_plugin_framework_providerserverv1_provider_proto_enumTypes[0]
}

func (x ContributionAction) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ContributionAction.Descriptor instead.
func (ContributionAction) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	// The status for when a link creation was interrupted due to deployment
	// being cancelled (e.g., drain timeout after terminal failure).
	// The actual state of the link is unknown and needs reconciliation.
	LinkStatus_LINK_STATUS_CREATE_INTERRUPTED LinkStatus = 19
	// The status for when a link update was interrupted due to deployment
	// being cancelled (e.g., drain timeout after terminal failure).
	// The actual state of the link is unknown and needs reconciliation.
	LinkStatus_LINK_STATUS_UPDATE_INTERRUPTED LinkStatus = 20
	// The status for when a link destruction was interrupted due to deployment
	// being cancelled (e.g., drain timeout after terminal failure).
	// The actual state of the link is unknown and needs reconciliation.
	LinkStatus_LINK_STATUS_DESTROY_INTERRUPTED LinkStatus = 21
)
...
var (
	LinkStatus_name = map[int32]string{
		...
		19: "LINK_STATUS_CREATE_INTERRUPTED",
		20: "LINK_STATUS_UPDATE_INTERRUPTED",
		21: "LINK_STATUS_DESTROY_INTERRUPTED",
	}
	LinkStatus_value = map[string]int32{
		...
		"LINK_STATUS_CREATE_INTERRUPTED":        19,
		"LINK_STATUS_UPDATE_INTERRUPTED":        20,
		"LINK_STATUS_DESTROY_INTERRUPTED":       21,
	}
)
...
const (
	...
	// The status for when the resource A update for a link was interrupted due to
	// deployment being cancelled (e.g., drain timeout after terminal failure).
	// The actual state is unknown and needs reconciliation.
	PreciseLinkStatus_PRECISE_LINK_STATUS_RESOURCE_A_UPDATE_INTERRUPTED PreciseLinkStatus = 19
	// The status for when the resource B update for a link was interrupted due to
	// deployment being cancelled (e.g., drain timeout after terminal failure).
	// The actual state is unknown and needs reconciliation.
	PreciseLinkStatus_PRECISE_LINK_STATUS_RESOURCE_B_UPDATE_INTERRUPTED PreciseLinkStatus = 20
	// The status for when the intermediary resources update for a link was interrupted
	// due to deployment being cancelled (e.g., drain timeout after terminal failure).
	// The actual state is unknown and needs reconciliation.
	PreciseLinkStatus_PRECISE_LINK_STATUS_INTERMEDIARY_RESOURCE_UPDATE_INTERRUPTED PreciseLinkStatus = 21
)
...
var (
	PreciseLinkStatus_name = map[int32]string{
		...
		19: "PRECISE_LINK_STATUS_RESOURCE_A_UPDATE_INTERRUPTED",
		20: "PRECISE_LINK_STATUS_RESOURCE_B_UPDATE_INTERRUPTED",
		21: "PRECISE_LINK_STATUS_INTERMEDIARY_RESOURCE_UPDATE_INTERRUPTED",
	}
	PreciseLinkStatus_value = map[string]int32{
		...
		"PRECISE_LINK_STATUS_RESOURCE_A_UPDATE_INTERRUPTED":                  19,
		"PRECISE_LINK_STATUS_RESOURCE_B_UPDATE_INTERRUPTED":                  20,
		"PRECISE_LINK_STATUS_INTERMEDIARY_RESOURCE_UPDATE_INTERRUPTED":       21,
	}
)
...
func (PreciseLinkStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_plugin_framework_providerserverv1_provider_proto_enumTypes[6].Descriptor()
}

func (PreciseLinkStatus) Type() protoreflect.EnumType {
	return &file_plugin_framework_providerserverv1_provider_proto_enumTypes[6]
}
...
// UpdateLinkedResourcesRequest provides the input data needed to update
// a link between two resources.
type UpdateLinkedResourcesRequest struct {
	state    protoimpl.MessageState `protogen:"open.v1"`
	LinkType *LinkType              `protobuf:"bytes,1,opt,name=link_type,json=linkType" json:"link_type,omitempty"`
	// The ID of the host making the request
	// to the provider.
	...
	ResourceAInfo    *sharedtypesv1.ResourceInfo `protobuf:"bytes,4,opt,name=resource_a_info,json=resourceAInfo" json:"resource_a_info,omitempty"`
	ResourceBInfo    *sharedtypesv1.ResourceInfo `protobuf:"bytes,5,opt,name=resource_b_info,json=resourceBInfo" json:"resource_b_info,omitempty"`
	...
	LinkId        string `protobuf:"bytes,10,opt,name=link_id,json=linkId" json:"link_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UpdateLinkedResourcesRequest) Reset() {
	*x = UpdateLinkedResourcesRequest{}
	mi := &file_plugin_framework_providerserverv1_provider_proto_msgTypes[31]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UpdateLinkedResourcesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateLinkedResourcesRequest) ProtoMessage() {}

func (x *UpdateLinkedResourcesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_framework_providerserverv1_provider_proto_msgTypes[31]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateLinkedResourcesRequest.ProtoReflect.Descriptor instead.
func (*UpdateLinkedResourcesRequest) Descriptor() ([]byte, []int) {
	return file_plugin_framework_providerserverv1_provider_proto_rawDescGZIP(), []int{31}
}

func (x *UpdateLinkedResourcesRequest) GetLinkType() *LinkType {
	if x != nil {
		return x.LinkType
	}
	return nil
...
func (x *UpdateLinkedResourcesRequest) GetHostId() string {
	if x != nil {
		return x.HostId
	}
	return ""
...
func (x *UpdateLinkedResourcesRequest) GetChanges() *sharedtypesv1.LinkChanges {
	if x != nil {
		return x.Changes
	}
	return nil
...
func (x *UpdateLinkedResourcesRequest) GetResourceAInfo() *sharedtypesv1.ResourceInfo {
	if x != nil {
...
func (x *UpdateLinkedResourcesRequest) GetResourceBInfo() *sharedtypesv1.ResourceInfo {
	if x != nil {
...
func (x *UpdateLinkedResourcesRequest) GetInstanceName() string {
	if x != nil {
		return x.InstanceName
	}
	return ""
...
func (x *UpdateLinkedResourcesRequest) GetUpdateType() LinkUpdateType {
	if x != nil {
		return x.UpdateType
	}
...
func (x *UpdateLinkedResourcesRequest) GetCurrentLinkState() *LinkState {
	if x != nil {
		return x.CurrentLinkState
	}
	return nil
...
func (x *UpdateLinkedResourcesRequest) GetContext() *LinkContext {
	if x != nil {
		return x.Context
	}
	return nil
...
func (x *UpdateLinkedResourcesRequest) GetLinkId() string {
	if x != nil {
		return x.LinkId
	}
	return ""
...
// ProduceResourceContributionsRequest provides the input data needed to produce a link's
// contributions to the blueprint-declared resources it writes.
type ProduceResourceContributionsRequest struct {
	state    protoimpl.MessageState `protogen:"open.v1"`
	LinkType *LinkType              `protobuf:"bytes,1,opt,name=link_type,json=linkType" json:"link_type,omitempty"`
	// The ID of the host making the request
	// to the provider.
...
func (x *ProduceResourceContributionsRequest) Reset() {
	*x = ProduceResourceContributionsRequest{}
	mi := &file_plugin_framework_providerserverv1_provider_proto_msgTypes[32]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ProduceResourceContributionsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProduceResourceContributionsRequest) ProtoMessage() {}

func (x *ProduceResourceContributionsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_framework_providerserverv1_provider_proto_msgTypes[32]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProduceResourceContributionsRequest.ProtoReflect.Descriptor instead.
func (*ProduceResourceContributionsRequest) Descriptor() ([]byte, []int) {
	return file_plugin_framework_providerserverv1_provider_proto_rawDescGZIP(), []int{32}
}

func (x *ProduceResourceContributionsRequest) GetLinkType() *LinkType {
	if x != nil {
		return x.LinkType
	}
	return nil
...
func (x *ProduceResourceContributionsRequest) GetHostId() string {
	if x != nil {
		return x.HostId
	}
	return ""
...
func (x *ProduceResourceContributionsRequest) GetChanges() *sharedtypesv1.LinkChanges {
	if x != nil {
		return x.Changes
	}
	return nil
...
func (x *ProduceResourceContributionsRequest) GetResourceAInfo() *sharedtypesv1.ResourceInfo {
	if x != nil {
		return x.ResourceAInfo
	}
	return nil
...
func (x *ProduceResourceContributionsRequest) GetResourceBInfo() *sharedtypesv1.ResourceInfo {
	if x != nil {
		return x.ResourceBInfo
	}
	return nil
...
func (x *ProduceResourceContributionsRequest) GetInstanceName() string {
	if x != nil {
		return x.InstanceName
	}
	return ""
...
func (x *ProduceResourceContributionsRequest) GetUpdateType() LinkUpdateType {
	if x != nil {
		return x.UpdateType
	}
	return LinkUpdateType_LINK_UPDATE_TYPE_CREATE
...
func (x *ProduceResourceContributionsRequest) GetCurrentLinkState() *LinkState {
	if x != nil {
		return x.CurrentLinkState
	}
	return nil
...
func (x *ProduceResourceContributionsRequest) GetContext() *LinkContext {
	if x != nil {
		return x.Context
	}
	return nil
...
func (x *ProduceResourceContributionsRequest) GetLinkId() string {
	if x != nil {
		return x.LinkId
	}
	return ""
...
// ProduceResourceContributionsResponse is the response containing the contributions a
// link makes to the resources it writes.
type ProduceResourceContributionsResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Response:
	//
	//	*ProduceResourceContributionsResponse_CompleteResponse
	//	*ProduceResourceContributionsResponse_ErrorResponse
	Response      isProduceResourceContributionsResponse_Response `protobuf_oneof:"response"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ProduceResourceContributionsResponse) Reset() {
	*x = ProduceResourceContributionsResponse{}
	mi := &file_plugin_framework_providerserverv1_provider_proto_msgTypes[33]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ProduceResourceContributionsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProduceResourceContributionsResponse) ProtoMessage() {}

func (x *ProduceResourceContributionsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_framework_providerserverv1_provider_proto_msgTypes[33]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProduceResourceContributionsResponse.ProtoReflect.Descriptor instead.
func (*ProduceResourceContributionsResponse) Descriptor() ([]byte, []int) {
	return file_plugin_framework_providerserverv1_provider_proto_rawDescGZIP(), []int{33}
}

func (x *ProduceResourceContributionsResponse) GetResponse() isProduceResourceContributionsResponse_Response {
	if x != nil {
		return x.Response
	}
	return nil
...
func (x *ProduceResourceContributionsResponse) GetCompleteResponse() *ProduceResourceContributionsCompleteResponse {
	if x != nil {
		if x, ok := x.Response.(*ProduceResourceContributionsResponse_CompleteResponse); ok {
			return x.CompleteResponse
		}
	}
	return nil
...
func (x *ProduceResourceContributionsResponse) GetErrorResponse() *sharedtypesv1.ErrorResponse {
	if x != nil {
		if x, ok := x.Response.(*ProduceResourceContributionsResponse_ErrorResponse); ok {
			return x.ErrorResponse
		}
	}
	return nil
...
type isProduceResourceContributionsResponse_Response interface {
	isProduceResourceContributionsResponse_Response()
}

type ProduceResourceContributionsResponse_CompleteResponse struct {
	CompleteResponse *ProduceResourceContributionsCompleteResponse `protobuf:"bytes,1,opt,name=complete_response,json=completeResponse,oneof"`
}

type ProduceResourceContributionsResponse_ErrorResponse struct {
	ErrorResponse *sharedtypesv1.ErrorResponse `protobuf:"bytes,2,opt,name=error_response,json=errorResponse,oneof"`
}

func (*ProduceResourceContributionsResponse_CompleteResponse) isProduceResourceContributionsResponse_Response() {
}

func (*ProduceResourceContributionsResponse_ErrorResponse) isProduceResourceContributionsResponse_Response() {
}

// ProduceResourceContributionsCompleteResponse contains the contributions a link makes,
// along with the state of any resources it created because a contribution needed their
// identity.
type ProduceResourceContributionsCompleteResponse struct {
	state                      protoimpl.MessageState           `protogen:"open.v1"`
	Contributions              []*ResourceContribution          `protobuf:"bytes,1,rep,name=contributions" json:"contributions,omitempty"`
	IntermediaryResourceStates []*LinkIntermediaryResourceState `protobuf:"bytes,2,rep,name=intermediary_resource_states,json=intermediaryResourceStates" json:"intermediary_resource_states,omitempty"`
	LinkData                   *schemapb.MappingNode            `protobuf:"bytes,3,opt,name=link_data,json=linkData" json:"link_data,omitempty"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}

func (x *ProduceResourceContributionsCompleteResponse) Reset() {
	*x = ProduceResourceContributionsCompleteResponse{}
	mi := &file_plugin_framework_providerserverv1_provider_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ProduceResourceContributionsCompleteResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProduceResourceContributionsCompleteResponse) ProtoMessage() {}

func (x *ProduceResourceContributionsCompleteResponse) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_framework_providerserverv1_provider_proto_msgTypes[34]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProduceResourceContributionsCompleteResponse.ProtoReflect.Descriptor instead.
func (*ProduceResourceContributionsCompleteResponse) Descriptor() ([]byte, []int) {
	return file_plugin_framework_providerserverv1_provider_proto_rawDescGZIP(), []int{34}
}

func (x *ProduceResourceContributionsCompleteResponse) GetContributions() []*ResourceContribution {
	if x != nil {
...
func (x *ProduceResourceContributionsCompleteResponse) GetIntermediaryResourceStates() []*LinkIntermediaryResourceState {
	if x != nil {
...
func (x *ProduceResourceContributionsCompleteResponse) GetLinkData() *schemapb.MappingNode {
	if x != nil {
		return x.LinkData
	}
	return nil
...
type ResourceContribution struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The logical name of the resource in the blueprint the contribution is made to,
	// which is not restricted to the two resources the link relates.
	ResourceName string `protobuf:"bytes,1,opt,name=resource_name,json=resourceName" json:"resource_name,omitempty"`
	// The path of the field in the resource's spec the contribution sets or appends to.
	FieldPath string                `protobuf:"bytes,2,opt,name=field_path,json=fieldPath" json:"field_path,omitempty"`
	Value     *schemapb.MappingNode `protobuf:"bytes,3,opt,name=value" json:"value,omitempty"`
	Action    ContributionAction    `protobuf:"varint,4,opt,name=action,enum=providerserverv1.ContributionAction" json:"action,omitempty"`
	// Keeps the contribution on the resource after the link that made it is removed.
	// Contributions are desired state, so leaving this unset retracts the value along
	// with the link.
	RetainOnRemoval bool `protobuf:"varint,5,opt,name=retain_on_removal,json=retainOnRemoval" json:"retain_on_removal,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *ResourceContribution) Reset() {
	*x = ResourceContribution{}
	mi := &file_plugin_framework_providerserverv1_provider_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ResourceContribution) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResourceContribution) ProtoMessage() {}

func (x *ResourceContribution) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_framework_providerserverv1_provider_proto_msgTypes[35]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResourceContribution.ProtoReflect.Descriptor instead.
func (*ResourceContribution) Descriptor() ([]byte, []int) {
	return file_plugin_framework_providerserverv1_provider_proto_rawDescGZIP(), []int{35}
}

func (x *ResourceContribution) GetResourceName() string {
	if x != nil {
		return x.ResourceName
	}
	return ""
...
func (x *ResourceContribution) GetFieldPath() string {
	if x != nil {
		return x.FieldPath
	}
	return ""
...
func (x *ResourceContribution) GetValue() *schemapb.MappingNode {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *ResourceContribution) GetAction() ContributionAction {
	if x != nil {
		return x.Action
	}
	return ContributionAction_CONTRIBUTION_ACTION_SET
}

func (x *ResourceContribution) GetRetainOnRemoval() bool {
	if x != nil {
		return x.RetainOnRemoval
	}
	return false
}

// UpdateLinkedResourcesResponse is the response
// containing the result of updating a resource as a part
// of a link.
type UpdateLinkedResourcesResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Response:
	//
	//	*UpdateLinkedResourcesResponse_CompleteResponse
	//	*UpdateLinkedResourcesResponse_ErrorResponse
	Response      isUpdateLinkedResourcesResponse_Response `protobuf_oneof:"response"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UpdateLinkedResourcesResponse) Reset() {
	*x = UpdateLinkedResourcesResponse{}
	mi := &file_plugin_framework_providerserverv1_provider_proto_msgTypes[36]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UpdateLinkedResourcesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateLinkedResourcesResponse) ProtoMessage() {}

func (x *UpdateLinkedResourcesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_framework_providerserverv1_provider_proto_msgTypes[36]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateLinkedResourcesResponse.ProtoReflect.Descriptor instead.
func (*UpdateLinkedResourcesResponse) Descriptor() ([]byte, []int) {
	return file_plugin_framework_providerserverv1_provider_proto_rawDescGZIP(), []int{36}
}

func (x *UpdateLinkedResourcesResponse) GetResponse() isUpdateLinkedResourcesResponse_Response {
	if x != nil {
		return x.Response
	}
	return nil
...
func (x *UpdateLinkedResourcesResponse) GetCompleteResponse() *UpdateLinkResourceCompleteResponse {
	if x != nil {
		if x, ok := x.Response.(*UpdateLinkedResourcesResponse_CompleteResponse); ok {
			return x.CompleteResponse
		}
	}
	return nil
...
func (x *UpdateLinkedResourcesResponse) GetErrorResponse() *sharedtypesv1.ErrorResponse {
	if x != nil {
		if x, ok := x.Response.(*UpdateLinkedResourcesResponse_ErrorResponse); ok {
			return x.ErrorResponse
		}
	}
	return nil
...
type isUpdateLinkedResourcesResponse_Response interface {
	isUpdateLinkedResourcesResponse_Response()
}

type UpdateLinkedResourcesResponse_CompleteResponse struct {
...
type UpdateLinkedResourcesResponse_ErrorResponse struct {
	ErrorResponse *sharedtypesv1.ErrorResponse `protobuf:"bytes,2,opt,name=error_response,json=errorResponse,oneof"`
}

func (*UpdateLinkedResourcesResponse_CompleteResponse) isUpdateLinkedResourcesResponse_Response() {}

func (*UpdateLinkedResourcesResponse_ErrorResponse) isUpdateLinkedResourcesResponse_Response() {}
...
type UpdateLinkResourceCompleteResponse struct {
	...
	ResourceDataMappings map[string]string      `protobuf:"bytes,2,rep,name=resource_data_mappings,json=resourceDataMappings" json:"resource_data_mappings,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
type UpdateLinkIntermediaryResourcesCompleteResponse struct {
	...
	ResourceDataMappings       map[string]string                `protobuf:"bytes,3,rep,name=resource_data_mappings,json=resourceDataMappings" json:"resource_data_mappings,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
type LinkIntermediaryResourceState struct {
	...
	PreciseStatus sharedtypesv1.PreciseResourceStatus `protobuf:"varint,5,opt,name=precise_status,json=preciseStatus,enum=sharedtypesv1.PreciseResourceStatus" json:"precise_status,omitempty"`
	...
	LastDeployAttemptTimestamp int64 `protobuf:"varint,7,opt,name=last_deploy_attempt_timestamp,json=lastDeployAttemptTimestamp" json:"last_deploy_attempt_timestamp,omitempty"`
...
type LinkCompletionDurations struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The duration information for the update of the blueprint-declared resources
	// the link relates.
	// This will only be present if the link has reached the linked resources
	// updated status.
	LinkedResourcesUpdate *LinkComponentCompletionDurations `protobuf:"bytes,1,opt,name=linked_resources_update,json=linkedResourcesUpdate" json:"linked_resources_update,omitempty"`
	...
	IntermediaryResources *LinkComponentCompletionDurations `protobuf:"bytes,2,opt,name=intermediary_resources,json=intermediaryResources" json:"intermediary_resources,omitempty"`
	// The duration in milliseconds for the link change to reach the final status.
	TotalDuration *wrapperspb.DoubleValue `protobuf:"bytes,3,opt,name=total_duration,json=totalDuration" json:"total_duration,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LinkCompletionDurations) GetLinkedResourcesUpdate() *LinkComponentCompletionDurations {
	if x != nil {
		return x.LinkedResourcesUpdate
	}
	return nil
}
...
// GetLinkIntermediaryExternalStateRequest provides the input data needed
// to fetch the external state of intermediary resources for a link.
...
func (x *GetLinkIntermediaryExternalStateRequest) Reset() {
	*x = GetLinkIntermediaryExternalStateRequest{}
...
func (x *GetLinkIntermediaryExternalStateRequest) GetIntermediaryResourceIds() []string {
	if x != nil {
		return x.IntermediaryResourceIds
	}
	return nil
}
...
// GetLinkIntermediaryExternalStateResponse contains the response
// for fetching external state of intermediary resources.
...
func (x *GetLinkIntermediaryExternalStateResponse) Reset() {
	*x = GetLinkIntermediaryExternalStateResponse{}
...
func (x *GetLinkIntermediaryExternalStateResponse) GetCompleteResponse() *GetLinkIntermediaryExternalStateCompleteResponse {
	if x != nil {
		if x, ok := x.Response.(*GetLinkIntermediaryExternalStateResponse_CompleteResponse); ok {
			return x.CompleteResponse
		}
	}
	return nil
...
func (x *GetLinkIntermediaryExternalStateResponse) GetErrorResponse() *sharedtypesv1.ErrorResponse {
	if x != nil {
		if x, ok := x.Response.(*GetLinkIntermediaryExternalStateResponse_ErrorResponse); ok {
			return x.ErrorResponse
		}
	}
	return nil
...
type isGetLinkIntermediaryExternalStateResponse_Response interface {
	isGetLinkIntermediaryExternalStateResponse_Response()
}
...
func (*GetLinkIntermediaryExternalStateResponse_CompleteResponse) isGetLinkIntermediaryExternalStateResponse_Response() {
}

func (*GetLinkIntermediaryExternalStateResponse_ErrorResponse) isGetLinkIntermediaryExternalStateResponse_Response() {
}

// GetLinkIntermediaryExternalStateCompleteResponse contains the external state
...
type GetLinkIntermediaryExternalStateCompleteResponse struct {
	...
	IntermediaryStates map[string]*IntermediaryExternalState `protobuf:"bytes,1,rep,name=intermediary_states,json=intermediaryStates" json:"intermediary_states,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}

func (x *GetLinkIntermediaryExternalStateCompleteResponse) Reset() {
	*x = GetLinkIntermediaryExternalStateCompleteResponse{}
...
func (x *GetLinkIntermediaryExternalStateCompleteResponse) GetIntermediaryStates() map[string]*IntermediaryExternalState {
	if x != nil {
		return x.IntermediaryStates
	}
	return nil
}

// ValidateLinkRequest is the request input for validating a link between two resources.
type ValidateLinkRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The specification of the first resource in the link relationship.
	ResourceASpec *schemapb.MappingNode `protobuf:"bytes,1,opt,name=resource_a_spec,json=resourceASpec" json:"resource_a_spec,omitempty"`
	// The specification of the second resource in the link relationship.
	ResourceBSpec *schemapb.MappingNode `protobuf:"bytes,2,opt,name=resource_b_spec,json=resourceBSpec" json:"resource_b_spec,omitempty"`
	// The logical name of resource A in the blueprint.
	ResourceAName string `protobuf:"bytes,3,opt,name=resource_a_name,json=resourceAName" json:"resource_a_name,omitempty"`
	// The logical name of resource B in the blueprint.
	ResourceBName string `protobuf:"bytes,4,opt,name=resource_b_name,json=resourceBName" json:"resource_b_name,omitempty"`
	// The type of resource A.
	ResourceAType *sharedtypesv1.ResourceType `protobuf:"bytes,5,opt,name=resource_a_type,json=resourceAType" json:"resource_a_type,omitempty"`
	// The type of resource B.
	ResourceBType *sharedtypesv1.ResourceType `protobuf:"bytes,6,opt,name=resource_b_type,json=resourceBType" json:"resource_b_type,omitempty"`
	// Annotations are the link-related annotations from both resources
	// in the link, keyed by "{resourceType}::{annotationName}".
	Annotations map[string]*schemapb.ScalarValue `protobuf:"bytes,7,rep,name=annotations" json:"annotations,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// Provides access to provider config and context variables.
	LinkContext *LinkContext `protobuf:"bytes,8,opt,name=link_context,json=linkContext" json:"link_context,omitempty"`
	// The ID of the host that the plugin is registered with.
	HostId        string `protobuf:"bytes,9,opt,name=host_id,json=hostId" json:"host_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ValidateLinkRequest) Reset() {
	*x = ValidateLinkRequest{}
	mi := &file_plugin_framework_providerserverv1_provider_proto_msgTypes[77]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ValidateLinkRequest) Descriptor() ([]byte, []int) {
	return file_plugin_framework_providerserverv1_provider_proto_rawDescGZIP(), []int{77}
}

func (x *ValidateLinkRequest) GetResourceASpec() *schemapb.MappingNode {
	if x != nil {
		return x.ResourceASpec
	}
	return nil
}

func (x *ValidateLinkRequest) GetResourceBSpec() *schemapb.MappingNode {
	if x != nil {
		return x.ResourceBSpec
	}
	return nil
}

func (x *ValidateLinkRequest) GetResourceAName() string {
	if x != nil {
		return x.ResourceAName
	}
	return ""
}

func (x *ValidateLinkRequest) GetResourceBName() string {
	if x != nil {
		return x.ResourceBName
	}
	return ""
}

func (x *ValidateLinkRequest) GetResourceAType() *sharedtypesv1.ResourceType {
	if x != nil {
		return x.ResourceAType
	}
	return nil
}

func (x *ValidateLinkRequest) GetResourceBType() *sharedtypesv1.ResourceType {
	if x != nil {
		return x.ResourceBType
	}
	return nil
}

func (x *ValidateLinkRequest) GetAnnotations() map[string]*schemapb.ScalarValue {
	if x != nil {
		return x.Annotations
	}
	return nil
...
func (x *ValidateLinkRequest) GetLinkContext() *LinkContext {
	if x != nil {
...
func (x *ValidateLinkRequest) GetHostId() string {
	if x != nil {
		return x.HostId
	}
	return ""
...
// ValidateLinkResponse is the response for validating a link between two resources.
type ValidateLinkResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Response:
	//
	//	*ValidateLinkResponse_CompleteResponse
	//	*ValidateLinkResponse_ErrorResponse
	Response      isValidateLinkResponse_Response `protobuf_oneof:"response"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ValidateLinkResponse) Reset() {
	*x = ValidateLinkResponse{}
	mi := &file_plugin_framework_providerserverv1_provider_proto_msgTypes[78]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ValidateLinkResponse) Descriptor() ([]byte, []int) {
	return file_plugin_framework_providerserverv1_provider_proto_rawDescGZIP(), []int{78}
}

func (x *ValidateLinkResponse) GetResponse() isValidateLinkResponse_Response {
	if x != nil {
		return x.Response
	}
	return nil
...
func (x *ValidateLinkResponse) GetCompleteResponse() *ValidateLinkCompleteResponse {
	if x != nil {
		if x, ok := x.Response.(*ValidateLinkResponse_CompleteResponse); ok {
			return x.CompleteResponse
		}
	}
	return nil
...
func (x *ValidateLinkResponse) GetErrorResponse() *sharedtypesv1.ErrorResponse {
	if x != nil {
		if x, ok := x.Response.(*ValidateLinkResponse_ErrorResponse); ok {
			return x.ErrorResponse
		}
	}
	return nil
...
type isValidateLinkResponse_Response interface {
	isValidateLinkResponse_Response()
}

type ValidateLinkResponse_CompleteResponse struct {
	CompleteResponse *ValidateLinkCompleteResponse `protobuf:"bytes,1,opt,name=complete_response,json=completeResponse,oneof"`
}

type ValidateLinkResponse_ErrorResponse struct {
	ErrorResponse *sharedtypesv1.ErrorResponse `protobuf:"bytes,2,opt,name=error_response,json=errorResponse,oneof"`
}

func (*ValidateLinkResponse_CompleteResponse) isValidateLinkResponse_Response() {}

func (*ValidateLinkResponse_ErrorResponse) isValidateLinkResponse_Response() {}

// ValidateLinkCompleteResponse contains the result of validating a link between two resources.
type ValidateLinkCompleteResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// A list of diagnostics related to validating the link.
	Diagnostics   []*sharedtypesv1.Diagnostic `protobuf:"bytes,1,rep,name=diagnostics" json:"diagnostics,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ValidateLinkCompleteResponse) Reset() {
	*x = ValidateLinkCompleteResponse{}
	mi := &file_plugin_framework_providerserverv1_provider_proto_msgTypes[79]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ValidateLinkCompleteResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ValidateLinkCompleteResponse) ProtoMessage() {}

func (x *ValidateLinkCompleteResponse) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_framework_providerserverv1_provider_proto_msgTypes[79]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ValidateLinkCompleteResponse.ProtoReflect.Descriptor instead.
func (*ValidateLinkCompleteResponse) Descriptor() ([]byte, []int) {
	return file_plugin_framework_providerserverv1_provider_proto_rawDescGZIP(), []int{79}
}

func (x *ValidateLinkCompleteResponse) GetDiagnostics() []*sharedtypesv1.Diagnostic {
	if x != nil {
		return x.Diagnostics
	}
	return nil
...
func (x *IntermediaryExternalState) Reset() {
	*x = IntermediaryExternalState{}
	mi := &file_plugin_framework_providerserverv1_provider_proto_msgTypes[80]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IntermediaryExternalState) Descriptor() ([]byte, []int) {
	return file_plugin_framework_providerserverv1_provider_proto_rawDescGZIP(), []int{80}
}
...
func (x *LinkContext) Reset() {
	*x = LinkContext{}
	mi := &file_plugin_framework_providerserverv1_provider_proto_msgTypes[81]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LinkContext) Descriptor() ([]byte, []int) {
	return file_plugin_framework_providerserverv1_provider_proto_rawDescGZIP(), []int{81}
}
...
func (x *DataSourceType) Reset() {
	*x = DataSourceType{}
	mi := &file_plugin_framework_providerserverv1_provider_proto_msgTypes[82]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DataSourceType) Descriptor() ([]byte, []int) {
	return file_plugin_framework_providerserverv1_provider_proto_rawDescGZIP(), []int{82}
}
...
func (x *CustomVariableType) Reset() {
	*x = CustomVariableType{}
	mi := &file_plugin_framework_providerserverv1_provider_proto_msgTypes[83]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomVariableType) Descriptor() ([]byte, []int) {
	return file_plugin_framework_providerserverv1_provider_proto_rawDescGZIP(), []int{83}
}
...
func (x *LinkType) Reset() {
	*x = LinkType{}
	mi := &file_plugin_framework_providerserverv1_provider_proto_msgTypes[84]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LinkType) Descriptor() ([]byte, []int) {
	return file_plugin_framework_providerserverv1_provider_proto_rawDescGZIP(), []int{84}
}
...
var file_plugin_framework_providerserverv1_provider_proto_rawDesc = string([]byte{
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x48, 0x00, 0x52, 0x0d, 0x65, 0x72, 0x72, 0x6f,
	0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0a, 0x0a, 0x08, 0x72, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xed, 0x03, 0x0a, 0x1f, 0x47, 0x65, 0x74, 0x52, 0x65, 0x73,
	...
	,
	...
	0x22, 0xa6, 0x01, 0x0a, 0x0f, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x65, 0x71,
	...
	,
	...
	0x52, 0x12, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65,
	0x54, 0x79, 0x70, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x68, 0x6f, 0x73, 0x74, 0x5f, 0x69, 0x64, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x68, 0x6f, 0x73, 0x74, 0x49, 0x64, 0x12, 0x38, 0x0a,
	...
	0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x52, 0x07,
	0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x22, 0xfb, 0x02, 0x0a, 0x17, 0x53, 0x74, 0x61, 0x67,
	0x65, 0x4c, 0x69, 0x6e, 0x6b, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x6e, 0x73, 0x12, 0x71, 0x0a, 0x1c, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6d, 0x65, 0x64, 0x69,
	0x61, 0x72, 0x79, 0x5f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x73, 0x74, 0x61,
	0x74, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x70, 0x72, 0x6f, 0x76,
	0x69, 0x64, 0x65, 0x72, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x76, 0x31, 0x2e, 0x4c, 0x69, 0x6e,
	...
	0x53, 0x74, 0x61, 0x74, 0x65, 0x73, 0x12, 0x30, 0x0a, 0x09, 0x6c, 0x69, 0x6e, 0x6b, 0x5f, 0x64,
	0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x73, 0x63, 0x68, 0x65,
	0x6d, 0x61, 0x2e, 0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x4e, 0x6f, 0x64, 0x65, 0x52, 0x08,
	0x6c, 0x69, 0x6e, 0x6b, 0x44, 0x61, 0x74, 0x61, 0x22, 0xef, 0x01, 0x0a, 0x14, 0x52, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x69, 0x6f,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x78, 0x74, 0x22, 0xe0, 0x01, 0x0a, 0x20, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x56, 0x61, 0x6c,
	0x69, 0x64, 0x61, 0x74, 0x65, 0x44, 0x61, 0x74, 0x61, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x69, 0x0a, 0x11, 0x63, 0x6f, 0x6d, 0x70, 0x6c,
	0x65, 0x74, 0x65, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x3a, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x73, 0x65, 0x72,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x54, 0x79, 0x70, 0x65, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75,
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xb2, 0x01, 0x0a, 0x18, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d,
	0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x54, 0x79, 0x70, 0x65, 0x4f, 0x70, 0x74, 0x69,
	0x6f, 0x6e, 0x12, 0x29, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x13, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x53, 0x63, 0x61, 0x6c, 0x61,
	0x72, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x14, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	0x61, 0x6c, 0x75, 0x65, 0x52, 0x05, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x6f,
	0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6f,
	0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x48, 0x0a, 0x06, 0x73, 0x65, 0x61, 0x72, 0x63,
	0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x30, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64,
	...
	,
	...
	0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2f, 0x0a, 0x13, 0x73, 0x75, 0x70, 0x70, 0x6f,
	0x72, 0x74, 0x65, 0x64, 0x5f, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x18, 0x04,
	0x20, 0x03, 0x28, 0x09, 0x52, 0x12, 0x73, 0x75, 0x70, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x64, 0x4f,
	0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x12, 0x25, 0x0a, 0x0e, 0x63, 0x6f, 0x6e, 0x66,
	0x6c, 0x69, 0x63, 0x74, 0x73, 0x5f, 0x77, 0x69, 0x74, 0x68, 0x18, 0x05, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x0d, 0x63, 0x6f, 0x6e, 0x66, 0x6c, 0x69, 0x63, 0x74, 0x73, 0x57, 0x69, 0x74, 0x68, 0x22,
	0x9c, 0x01, 0x0a, 0x1d, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x76, 0x65, 0x64, 0x44, 0x61, 0x74, 0x61,
	...
	,
	...
	,
	...
	0x33, 0x0a, 0x15, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x74, 0x65, 0x64, 0x5f, 0x64, 0x65, 0x73,
	...
	,
	...
	0x52, 0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x22, 0xc2, 0x01, 0x0a, 0x18, 0x4c, 0x69, 0x6e, 0x6b,
	0x50, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x49, 0x6e, 0x66, 0x6f, 0x12, 0x53, 0x0a, 0x11, 0x70, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79,
	0x5f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32,
	...
	,
	...
	0x76, 0x31, 0x2e, 0x4c, 0x69, 0x6e, 0x6b, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x4a, 0x0a, 0x0e, 0x70, 0x72, 0x65, 0x63, 0x69, 0x73, 0x65,
	0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x23, 0x2e,
	0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x76, 0x31,
	0x2e, 0x50, 0x72, 0x65, 0x63, 0x69, 0x73, 0x65, 0x4c, 0x69, 0x6e, 0x6b, 0x53, 0x74, 0x61, 0x74,
	...
	0x70, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x19, 0x6c, 0x61, 0x73, 0x74, 0x53, 0x74, 0x61,
	...
	0x79, 0x65, 0x64, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x18, 0x07, 0x20,
	...
	,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x73, 0x63,
	0x68, 0x65, 0x6d, 0x61, 0x2e, 0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x4e, 0x6f, 0x64, 0x65,
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xf1, 0x03, 0x0a, 0x1d,
	0x4c, 0x69, 0x6e, 0x6b, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x72, 0x79,
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x1f, 0x0a,
	...
	0x63, 0x65, 0x49, 0x64, 0x12, 0x35, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x04,
	...
	0x01, 0x28, 0x0e, 0x32, 0x24, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x74, 0x79, 0x70, 0x65,
	0x73, 0x76, 0x31, 0x2e, 0x50, 0x72, 0x65, 0x63, 0x69, 0x73, 0x65, 0x52, 0x65, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x0d, 0x70, 0x72, 0x65, 0x63, 0x69,
	0x73, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x36, 0x0a, 0x17, 0x6c, 0x61, 0x73, 0x74,
	0x5f, 0x64, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x65, 0x64, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74,
	0x61, 0x6d, 0x70, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x15, 0x6c, 0x61, 0x73, 0x74, 0x44,
	...
	,
	...
	,
	...
	0x75, 0x65, 0x52, 0x0d, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x12, 0x2b, 0x0a, 0x11, 0x61, 0x74, 0x74, 0x65, 0x6d, 0x70, 0x74, 0x5f, 0x64, 0x75, 0x72,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x01, 0x52, 0x10, 0x61, 0x74,
	0x74, 0x65, 0x6d, 0x70, 0x74, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x98,
	0x01, 0x0a, 0x0b, 0x4c, 0x69, 0x6e, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x37,
	...
	,
	...
	0x0c, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x17, 0x0a,
	0x07, 0x6c, 0x69, 0x6e, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06,
	0x6c, 0x69, 0x6e, 0x6b, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x6c, 0x69, 0x6e, 0x6b, 0x5f, 0x6e,
	0x61, 0x6d, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6c, 0x69, 0x6e, 0x6b, 0x4e,
	0x61, 0x6d, 0x65, 0x12, 0x43, 0x0a, 0x0f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f,
	0x61, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x73,
	...
	,
	...
	,
	...
	,
	...
	0x0a, 0x14, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x4c, 0x69, 0x6e, 0x6b, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5d, 0x0a, 0x11, 0x63, 0x6f, 0x6d, 0x70, 0x6c, 0x65,
	0x74, 0x65, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x2e, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x73, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x76, 0x31, 0x2e, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x4c, 0x69, 0x6e,
	...
	0x72, 0x6f, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x48, 0x00, 0x52, 0x0d, 0x65,
	0x72, 0x72, 0x6f, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0a, 0x0a, 0x08,
	0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x5b, 0x0a, 0x1c, 0x56, 0x61, 0x6c, 0x69,
	0x64, 0x61, 0x74, 0x65, 0x4c, 0x69, 0x6e, 0x6b, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65,
	...
	0x73, 0x74, 0x69, 0x63, 0x73, 0x22, 0xab, 0x01, 0x0a, 0x19, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x6d,
	0x65, 0x64, 0x69, 0x61, 0x72, 0x79, 0x45, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x53, 0x74,
	...
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x30, 0x0a, 0x09, 0x73, 0x70, 0x65,
	0x63, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x73,
	0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x4e, 0x6f, 0x64,
	0x65, 0x52, 0x08, 0x73, 0x70, 0x65, 0x63, 0x44, 0x61, 0x74, 0x61, 0x12, 0x16, 0x0a, 0x06, 0x65,
	0x78, 0x69, 0x73, 0x74, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x65, 0x78, 0x69,
	0x73, 0x74, 0x73, 0x22, 0xa2, 0x03, 0x0a, 0x0b, 0x4c, 0x69, 0x6e, 0x6b, 0x43, 0x6f, 0x6e, 0x74,
	0x65, 0x78, 0x74, 0x12, 0x76, 0x0a, 0x19, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x5f,
	...
	,
	...
	0x0a, 0x15, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c,
	...
	,
	...
	,
	...
	,
	...
	0x15, 0x32, 0xf5, 0x26, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x12, 0x58,
	...
	,
	...
	0x65, 0x73, 0x12, 0x21, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x73, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x76, 0x31, 0x2e, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x27, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72,
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x76, 0x31, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x54, 0x79, 0x70, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00,
	0x12, 0x59, 0x0a, 0x0d, 0x4c, 0x69, 0x73, 0x74, 0x4c, 0x69, 0x6e, 0x6b, 0x54, 0x79, 0x70, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x00, 0x12, 0x98, 0x01, 0x0a, 0x1f, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4c, 0x69, 0x6e, 0x6b,
	0x49, 0x6e, 0x74, 0x65, 0x72, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x72, 0x79, 0x52, 0x65, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x73, 0x12, 0x38, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72,
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x76, 0x31, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4c,
	...
	,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x83, 0x01, 0x0a, 0x18, 0x43, 0x75, 0x73, 0x74,
	0x6f, 0x6d, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x44, 0x61, 0x74, 0x61, 0x53, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x12, 0x31, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x73,
	0x65, 0x72, 0x76, 0x65, 0x72, 0x76, 0x31, 0x2e, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x56, 0x61,
	0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x44, 0x61, 0x74, 0x61, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x32, 0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64,
	0x65, 0x72, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x76, 0x31, 0x2e, 0x43, 0x75, 0x73, 0x74, 0x6f,
	...
	,
	...
	,
...
var file_plugin_framework_providerserverv1_provider_proto_enumTypes = make([]protoimpl.EnumInfo, 7)
var file_plugin_framework_providerserverv1_provider_proto_msgTypes = make([]protoimpl.MessageInfo, 97)
var file_plugin_framework_providerserverv1_provider_proto_goTypes = []any{
	(ContributionAction)(0),                                  // 0: providerserverv1.ContributionAction
	(DataSourceSpecSchemaType)(0),                            // 1: providerserverv1.DataSourceSpecSchemaType
	(LinkPriorityResource)(0),                                // 2: providerserverv1.LinkPriorityResource
	(LinkKind)(0),                                            // 3: providerserverv1.LinkKind
	(LinkUpdateType)(0),                                      // 4: providerserverv1.LinkUpdateType
	(LinkStatus)(0),                                          // 5: providerserverv1.LinkStatus
	(PreciseLinkStatus)(0),                                   // 6: providerserverv1.PreciseLinkStatus
	(*NamespaceResponse)(nil),                                // 7: providerserverv1.NamespaceResponse
	(*Namespace)(nil),                                        // 8: providerserverv1.Namespace
	(*ResourceTypesResponse)(nil),                            // 9: providerserverv1.ResourceTypesResponse
	(*ResourceTypes)(nil),                                    // 10: providerserverv1.ResourceTypes
	(*LinkTypesResponse)(nil),                                // 11: providerserverv1.LinkTypesResponse
	(*LinkTypes)(nil),                                        // 12: providerserverv1.LinkTypes
	(*DataSourceTypesResponse)(nil),                          // 13: providerserverv1.DataSourceTypesResponse
	(*DataSourceTypes)(nil),                                  // 14: providerserverv1.DataSourceTypes
	(*CustomVariableTypesResponse)(nil),                      // 15: providerserverv1.CustomVariableTypesResponse
	(*CustomVariableTypes)(nil),                              // 16: providerserverv1.CustomVariableTypes
	(*FunctionListResponse)(nil),                             // 17: providerserverv1.FunctionListResponse
	(*FunctionList)(nil),                                     // 18: providerserverv1.FunctionList
	(*RetryPolicyResponse)(nil),                              // 19: providerserverv1.RetryPolicyResponse
	(*RetryPolicy)(nil),                                      // 20: providerserverv1.RetryPolicy
	(*CustomValidateResourceRequest)(nil),                    // 21: providerserverv1.CustomValidateResourceRequest
	(*CustomValidateResourceResponse)(nil),                   // 22: providerserverv1.CustomValidateResourceResponse
	(*CustomValidateResourceCompleteResponse)(nil),           // 23: providerserverv1.CustomValidateResourceCompleteResponse
	(*ResourceSpecDefinitionResponse)(nil),                   // 24: providerserverv1.ResourceSpecDefinitionResponse
	(*CanResourceLinkToResponse)(nil),                        // 25: providerserverv1.CanResourceLinkToResponse
	(*ResourceStabilisedDepsResponse)(nil),                   // 26: providerserverv1.ResourceStabilisedDepsResponse
	(*StabilisedDependencies)(nil),                           // 27: providerserverv1.StabilisedDependencies
	(*IsResourceCommonTerminalResponse)(nil),                 // 28: providerserverv1.IsResourceCommonTerminalResponse
	(*GetResourceExternalStateRequest)(nil),                  // 29: providerserverv1.GetResourceExternalStateRequest
	(*GetResourceExternalStateResponse)(nil),                 // 30: providerserverv1.GetResourceExternalStateResponse
	(*ProviderRequest)(nil),                                  // 31: providerserverv1.ProviderRequest
	(*ResourceRequest)(nil),                                  // 32: providerserverv1.ResourceRequest
	(*DataSourceRequest)(nil),                                // 33: providerserverv1.DataSourceRequest
	(*CustomVariableTypeRequest)(nil),                        // 34: providerserverv1.CustomVariableTypeRequest
	(*StageLinkChangesRequest)(nil),                          // 35: providerserverv1.StageLinkChangesRequest
	(*StageLinkChangesResponse)(nil),                         // 36: providerserverv1.StageLinkChangesResponse
	(*StageLinkChangesCompleteResponse)(nil),                 // 37: providerserverv1.StageLinkChangesCompleteResponse
	(*UpdateLinkedResourcesRequest)(nil),                     // 38: providerserverv1.UpdateLinkedResourcesRequest
	(*ProduceResourceContributionsRequest)(nil),              // 39: providerserverv1.ProduceResourceContributionsRequest
	(*ProduceResourceContributionsResponse)(nil),             // 40: providerserverv1.ProduceResourceContributionsResponse
	(*ProduceResourceContributionsCompleteResponse)(nil),     // 41: providerserverv1.ProduceResourceContributionsCompleteResponse
	(*ResourceContribution)(nil),                             // 42: providerserverv1.ResourceContribution
	(*UpdateLinkedResourcesResponse)(nil),                    // 43: providerserverv1.UpdateLinkedResourcesResponse
	(*UpdateLinkResourceCompleteResponse)(nil),               // 44: providerserverv1.UpdateLinkResourceCompleteResponse
	(*UpdateLinkIntermediaryResourcesRequest)(nil),           // 45: providerserverv1.UpdateLinkIntermediaryResourcesRequest
	(*UpdateLinkIntermediaryResourcesResponse)(nil),          // 46: providerserverv1.UpdateLinkIntermediaryResourcesResponse
	(*UpdateLinkIntermediaryResourcesCompleteResponse)(nil),  // 47: providerserverv1.UpdateLinkIntermediaryResourcesCompleteResponse
	(*LinkPriorityResourceResponse)(nil),                     // 48: providerserverv1.LinkPriorityResourceResponse
	(*CustomValidateDataSourceRequest)(nil),                  // 49: providerserverv1.CustomValidateDataSourceRequest
	(*CustomValidateDataSourceResponse)(nil),                 // 50: providerserverv1.CustomValidateDataSourceResponse
	(*CustomValidateDataSourceCompleteResponse)(nil),         // 51: providerserverv1.CustomValidateDataSourceCompleteResponse
	(*DataSourceSpecDefinitionResponse)(nil),                 // 52: providerserverv1.DataSourceSpecDefinitionResponse
	(*DataSourceFilterFieldsResponse)(nil),                   // 53: providerserverv1.DataSourceFilterFieldsResponse
	(*FetchDataSourceRequest)(nil),                           // 54: providerserverv1.FetchDataSourceRequest
	(*FetchDataSourceResponse)(nil),                          // 55: providerserverv1.FetchDataSourceResponse
	(*CustomVariableTypeOptionsResponse)(nil),                // 56: providerserverv1.CustomVariableTypeOptionsResponse
	(*CustomVariableTypeOptions)(nil),                        // 57: providerserverv1.CustomVariableTypeOptions
	(*CustomVariableTypeOption)(nil),                         // 58: providerserverv1.CustomVariableTypeOption
	(*CustomVariableTypeResponse)(nil),                       // 59: providerserverv1.CustomVariableTypeResponse
	(*CustomVariableTypeInfo)(nil),                           // 60: providerserverv1.CustomVariableTypeInfo
	(*FetchDataSourceCompleteResponse)(nil),                  // 61: providerserverv1.FetchDataSourceCompleteResponse
	(*ResolvedDataSource)(nil),                               // 62: providerserverv1.ResolvedDataSource
	(*ResolvedDataSourceMetadata)(nil),                       // 63: providerserverv1.ResolvedDataSourceMetadata
	(*ResolvedDataSourceFilter)(nil),                         // 64: providerserverv1.ResolvedDataSourceFilter
	(*ResolvedDataSourceFilterSearch)(nil),                   // 65: providerserverv1.ResolvedDataSourceFilterSearch
	(*DataSourceFilterFields)(nil),                           // 66: providerserverv1.DataSourceFilterFields
	(*DataSourceFilterFieldSchema)(nil),                      // 67: providerserverv1.DataSourceFilterFieldSchema
	(*ResolvedDataSourceFieldExport)(nil),                    // 68: providerserverv1.ResolvedDataSourceFieldExport
	(*DataSourceSpecDefinition)(nil),                         // 69: providerserverv1.DataSourceSpecDefinition
	(*DataSourceSpecSchema)(nil),                             // 70: providerserverv1.DataSourceSpecSchema
	(*DataSourceTypeResponse)(nil),                           // 71: providerserverv1.DataSourceTypeResponse
	(*DataSourceTypeInfo)(nil),                               // 72: providerserverv1.DataSourceTypeInfo
	(*LinkPriorityResourceInfo)(nil),                         // 73: providerserverv1.LinkPriorityResourceInfo
	(*LinkKindResponse)(nil),                                 // 74: providerserverv1.LinkKindResponse
	(*LinkKindInfo)(nil),                                     // 75: providerserverv1.LinkKindInfo
	(*LinkState)(nil),                                        // 76: providerserverv1.LinkState
	(*LinkIntermediaryResourceState)(nil),                    // 77: providerserverv1.LinkIntermediaryResourceState
	(*LinkCompletionDurations)(nil),                          // 78: providerserverv1.LinkCompletionDurations
	(*LinkComponentCompletionDurations)(nil),                 // 79: providerserverv1.LinkComponentCompletionDurations
	(*LinkRequest)(nil),                                      // 80: providerserverv1.LinkRequest
	(*GetLinkIntermediaryExternalStateRequest)(nil),          // 81: providerserverv1.GetLinkIntermediaryExternalStateRequest
	(*GetLinkIntermediaryExternalStateResponse)(nil),         // 82: providerserverv1.GetLinkIntermediaryExternalStateResponse
	(*GetLinkIntermediaryExternalStateCompleteResponse)(nil), // 83: providerserverv1.GetLinkIntermediaryExternalStateCompleteResponse
	(*ValidateLinkRequest)(nil),                              // 84: providerserverv1.ValidateLinkRequest
	(*ValidateLinkResponse)(nil),                             // 85: providerserverv1.ValidateLinkResponse
	(*ValidateLinkCompleteResponse)(nil),                     // 86: providerserverv1.ValidateLinkCompleteResponse
	(*IntermediaryExternalState)(nil),                        // 87: providerserverv1.IntermediaryExternalState
	(*LinkContext)(nil),                                      // 88: providerserverv1.LinkContext
	(*DataSourceType)(nil),                                   // 89: providerserverv1.DataSourceType
	(*CustomVariableType)(nil),                               // 90: providerserverv1.CustomVariableType
	(*LinkType)(nil),                                         // 91: providerserverv1.LinkType
	nil,                                                      // 92: providerserverv1.UpdateLinkResourceCompleteResponse.ResourceDataMappingsEntry
	nil,                                                      // 93: providerserverv1.UpdateLinkIntermediaryResourcesCompleteResponse.ResourceDataMappingsEntry
	nil,                                                      // 94: providerserverv1.CustomVariableTypeOptions.OptionsEntry
	nil,                                                      // 95: providerserverv1.FetchDataSourceCompleteResponse.DataEntry
	nil,                                                      // 96: providerserverv1.ResolvedDataSource.ExportsEntry
	nil,                                                      // 97: providerserverv1.DataSourceFilterFields.FilterFieldsEntry
	nil,                                                      // 98: providerserverv1.DataSourceSpecDefinition.FieldsEntry
	nil,                                                      // 99: providerserverv1.LinkState.DataEntry
	nil,                                                      // 100: providerserverv1.GetLinkIntermediaryExternalStateCompleteResponse.IntermediaryStatesEntry
	nil,                                                      // 101: providerserverv1.ValidateLinkRequest.AnnotationsEntry
	nil,                                                      // 102: providerserverv1.LinkContext.ProviderConfigVariablesEntry
	nil,                                                      // 103: providerserverv1.LinkContext.ContextVariablesEntry
	(*sharedtypesv1.ErrorResponse)(nil),                      // 104: sharedtypesv1.ErrorResponse
	(*sharedtypesv1.ResourceType)(nil),                       // 105: sharedtypesv1.ResourceType
	(*schemapb.Resource)(nil),                                // 106: schema.Resource
	(*sharedtypesv1.ProviderContext)(nil),                    // 107: sharedtypesv1.ProviderContext
	(*sharedtypesv1.Diagnostic)(nil),                         // 108: sharedtypesv1.Diagnostic
	(*sharedtypesv1.ResourceSpecDefinition)(nil),             // 109: sharedtypesv1.ResourceSpecDefinition
	(*sharedtypesv1.CanLinkTo)(nil),                          // 110: sharedtypesv1.CanLinkTo
	(*sharedtypesv1.ResourceCommonTerminalInfo)(nil),         // 111: sharedtypesv1.ResourceCommonTerminalInfo
	(*schemapb.MappingNode)(nil),                             // 112: schema.MappingNode
	(*sharedtypesv1.ResourceMetadataState)(nil),              // 113: sharedtypesv1.ResourceMetadataState
	(*sharedtypesv1.Changes)(nil),                            // 114: sharedtypesv1.Changes
	(*sharedtypesv1.LinkChanges)(nil),                        // 115: sharedtypesv1.LinkChanges
	(*sharedtypesv1.ResourceInfo)(nil),                       // 116: sharedtypesv1.ResourceInfo
	(*schemapb.DataSource)(nil),                              // 117: schema.DataSource
	(*schemapb.ScalarValue)(nil),                             // 118: schema.ScalarValue
	(sharedtypesv1.ResourceStatus)(0),                        // 119: sharedtypesv1.ResourceStatus
	(sharedtypesv1.PreciseResourceStatus)(0),                 // 120: sharedtypesv1.PreciseResourceStatus
	(*wrapperspb.DoubleValue)(nil),                           // 121: google.protobuf.DoubleValue
	(*sharedtypesv1.DeployResourceRequest)(nil),              // 122: sharedtypesv1.DeployResourceRequest
	(*sharedtypesv1.ResourceHasStabilisedRequest)(nil),       // 123: sharedtypesv1.ResourceHasStabilisedRequest
	(*sharedtypesv1.DestroyResourceRequest)(nil),             // 124: sharedtypesv1.DestroyResourceRequest
	(*sharedtypesv1.FunctionDefinitionRequest)(nil),          // 125: sharedtypesv1.FunctionDefinitionRequest
	(*sharedtypesv1.FunctionCallRequest)(nil),                // 126: sharedtypesv1.FunctionCallRequest
	(*sharedtypesv1.ConfigDefinitionResponse)(nil),           // 127: sharedtypesv1.ConfigDefinitionResponse
	(*sharedtypesv1.ResourceTypeResponse)(nil),               // 128: sharedtypesv1.ResourceTypeResponse
	(*sharedtypesv1.TypeDescriptionResponse)(nil),            // 129: sharedtypesv1.TypeDescriptionResponse
	(*sharedtypesv1.ExamplesResponse)(nil),                   // 130: sharedtypesv1.ExamplesResponse
	(*sharedtypesv1.DeployResourceResponse)(nil),             // 131: sharedtypesv1.DeployResourceResponse
	(*sharedtypesv1.ResourceHasStabilisedResponse)(nil),      // 132: sharedtypesv1.ResourceHasStabilisedResponse
	(*sharedtypesv1.DestroyResourceResponse)(nil),            // 133: sharedtypesv1.DestroyResourceResponse
	(*sharedtypesv1.LinkAnnotationDefinitionsResponse)(nil),  // 134: sharedtypesv1.LinkAnnotationDefinitionsResponse
	(*sharedtypesv1.LinkCardinalityResponse)(nil),            // 135: sharedtypesv1.LinkCardinalityResponse
	(*sharedtypesv1.LinkCapabilitiesResponse)(nil),           // 136: sharedtypesv1.LinkCapabilitiesResponse
	(*sharedtypesv1.FunctionDefinitionResponse)(nil),         // 137: sharedtypesv1.FunctionDefinitionResponse
	(*sharedtypesv1.FunctionCallResponse)(nil),               // 138: sharedtypesv1.FunctionCallResponse
}
var file_plugin_framework_providerserverv1_provider_proto_depIdxs = []int32{
	8,   // 0: providerserverv1.NamespaceResponse.namespace:type_name -> providerserverv1.Namespace
	104, // 1: providerserverv1.NamespaceResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	10,  // 2: providerserverv1.ResourceTypesResponse.resource_types:type_name -> providerserverv1.ResourceTypes
	104, // 3: providerserverv1.ResourceTypesResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	105, // 4: providerserverv1.ResourceTypes.resource_types:type_name -> sharedtypesv1.ResourceType
	12,  // 5: providerserverv1.LinkTypesResponse.link_types:type_name -> providerserverv1.LinkTypes
	104, // 6: providerserverv1.LinkTypesResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	91,  // 7: providerserverv1.LinkTypes.link_types:type_name -> providerserverv1.LinkType
	14,  // 8: providerserverv1.DataSourceTypesResponse.data_source_types:type_name -> providerserverv1.DataSourceTypes
	104, // 9: providerserverv1.DataSourceTypesResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	89,  // 10: providerserverv1.DataSourceTypes.data_source_types:type_name -> providerserverv1.DataSourceType
	16,  // 11: providerserverv1.CustomVariableTypesResponse.custom_variable_types:type_name -> providerserverv1.CustomVariableTypes
	104, // 12: providerserverv1.CustomVariableTypesResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	90,  // 13: providerserverv1.CustomVariableTypes.custom_variable_types:type_name -> providerserverv1.CustomVariableType
	18,  // 14: providerserverv1.FunctionListResponse.function_list:type_name -> providerserverv1.FunctionList
	104, // 15: providerserverv1.FunctionListResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	20,  // 16: providerserverv1.RetryPolicyResponse.retry_policy:type_name -> providerserverv1.RetryPolicy
	104, // 17: providerserverv1.RetryPolicyResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	105, // 18: providerserverv1.CustomValidateResourceRequest.resource_type:type_name -> sharedtypesv1.ResourceType
	106, // 19: providerserverv1.CustomValidateResourceRequest.schema_resource:type_name -> schema.Resource
	107, // 20: providerserverv1.CustomValidateResourceRequest.context:type_name -> sharedtypesv1.ProviderContext
	23,  // 21: providerserverv1.CustomValidateResourceResponse.complete_response:type_name -> providerserverv1.CustomValidateResourceCompleteResponse
	104, // 22: providerserverv1.CustomValidateResourceResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	108, // 23: providerserverv1.CustomValidateResourceCompleteResponse.diagnostics:type_name -> sharedtypesv1.Diagnostic
	109, // 24: providerserverv1.ResourceSpecDefinitionResponse.spec_definition:type_name -> sharedtypesv1.ResourceSpecDefinition
	104, // 25: providerserverv1.ResourceSpecDefinitionResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	110, // 26: providerserverv1.CanResourceLinkToResponse.resource_types:type_name -> sharedtypesv1.CanLinkTo
	104, // 27: providerserverv1.CanResourceLinkToResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	27,  // 28: providerserverv1.ResourceStabilisedDepsResponse.stabilised_dependencies:type_name -> providerserverv1.StabilisedDependencies
	104, // 29: providerserverv1.ResourceStabilisedDepsResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	105, // 30: providerserverv1.StabilisedDependencies.resource_types:type_name -> sharedtypesv1.ResourceType
	111, // 31: providerserverv1.IsResourceCommonTerminalResponse.data:type_name -> sharedtypesv1.ResourceCommonTerminalInfo
	104, // 32: providerserverv1.IsResourceCommonTerminalResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	105, // 33: providerserverv1.GetResourceExternalStateRequest.resource_type:type_name -> sharedtypesv1.ResourceType
	112, // 34: providerserverv1.GetResourceExternalStateRequest.current_resource_spec:type_name -> schema.MappingNode
	113, // 35: providerserverv1.GetResourceExternalStateRequest.current_resource_metadata:type_name -> sharedtypesv1.ResourceMetadataState
	107, // 36: providerserverv1.GetResourceExternalStateRequest.context:type_name -> sharedtypesv1.ProviderContext
	112, // 37: providerserverv1.GetResourceExternalStateResponse.resource_spec_state:type_name -> schema.MappingNode
	104, // 38: providerserverv1.GetResourceExternalStateResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	105, // 39: providerserverv1.ResourceRequest.resource_type:type_name -> sharedtypesv1.ResourceType
	107, // 40: providerserverv1.ResourceRequest.context:type_name -> sharedtypesv1.ProviderContext
	89,  // 41: providerserverv1.DataSourceRequest.data_source_type:type_name -> providerserverv1.DataSourceType
	107, // 42: providerserverv1.DataSourceRequest.context:type_name -> sharedtypesv1.ProviderContext
	90,  // 43: providerserverv1.CustomVariableTypeRequest.custom_variable_type:type_name -> providerserverv1.CustomVariableType
	107, // 44: providerserverv1.CustomVariableTypeRequest.context:type_name -> sharedtypesv1.ProviderContext
	91,  // 45: providerserverv1.StageLinkChangesRequest.link_type:type_name -> providerserverv1.LinkType
	114, // 46: providerserverv1.StageLinkChangesRequest.resource_a_changes:type_name -> sharedtypesv1.Changes
	114, // 47: providerserverv1.StageLinkChangesRequest.resource_b_changes:type_name -> sharedtypesv1.Changes
	76,  // 48: providerserverv1.StageLinkChangesRequest.current_link_state:type_name -> providerserverv1.LinkState
	88,  // 49: providerserverv1.StageLinkChangesRequest.context:type_name -> providerserverv1.LinkContext
	37,  // 50: providerserverv1.StageLinkChangesResponse.complete_response:type_name -> providerserverv1.StageLinkChangesCompleteResponse
	104, // 51: providerserverv1.StageLinkChangesResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	115, // 52: providerserverv1.StageLinkChangesCompleteResponse.changes:type_name -> sharedtypesv1.LinkChanges
	91,  // 53: providerserverv1.UpdateLinkedResourcesRequest.link_type:type_name -> providerserverv1.LinkType
	115, // 54: providerserverv1.UpdateLinkedResourcesRequest.changes:type_name -> sharedtypesv1.LinkChanges
	116, // 55: providerserverv1.UpdateLinkedResourcesRequest.resource_a_info:type_name -> sharedtypesv1.ResourceInfo
	116, // 56: providerserverv1.UpdateLinkedResourcesRequest.resource_b_info:type_name -> sharedtypesv1.ResourceInfo
	4,   // 57: providerserverv1.UpdateLinkedResourcesRequest.update_type:type_name -> providerserverv1.LinkUpdateType
	76,  // 58: providerserverv1.UpdateLinkedResourcesRequest.current_link_state:type_name -> providerserverv1.LinkState
	88,  // 59: providerserverv1.UpdateLinkedResourcesRequest.context:type_name -> providerserverv1.LinkContext
	91,  // 60: providerserverv1.ProduceResourceContributionsRequest.link_type:type_name -> providerserverv1.LinkType
	115, // 61: providerserverv1.ProduceResourceContributionsRequest.changes:type_name -> sharedtypesv1.LinkChanges
	116, // 62: providerserverv1.ProduceResourceContributionsRequest.resource_a_info:type_name -> sharedtypesv1.ResourceInfo
	116, // 63: providerserverv1.ProduceResourceContributionsRequest.resource_b_info:type_name -> sharedtypesv1.ResourceInfo
	4,   // 64: providerserverv1.ProduceResourceContributionsRequest.update_type:type_name -> providerserverv1.LinkUpdateType
	76,  // 65: providerserverv1.ProduceResourceContributionsRequest.current_link_state:type_name -> providerserverv1.LinkState
	88,  // 66: providerserverv1.ProduceResourceContributionsRequest.context:type_name -> providerserverv1.LinkContext
	41,  // 67: providerserverv1.ProduceResourceContributionsResponse.complete_response:type_name -> providerserverv1.ProduceResourceContributionsCompleteResponse
	104, // 68: providerserverv1.ProduceResourceContributionsResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	42,  // 69: providerserverv1.ProduceResourceContributionsCompleteResponse.contributions:type_name -> providerserverv1.ResourceContribution
	77,  // 70: providerserverv1.ProduceResourceContributionsCompleteResponse.intermediary_resource_states:type_name -> providerserverv1.LinkIntermediaryResourceState
	112, // 71: providerserverv1.ProduceResourceContributionsCompleteResponse.link_data:type_name -> schema.MappingNode
	112, // 72: providerserverv1.ResourceContribution.value:type_name -> schema.MappingNode
	0,   // 73: providerserverv1.ResourceContribution.action:type_name -> providerserverv1.ContributionAction
	44,  // 74: providerserverv1.UpdateLinkedResourcesResponse.complete_response:type_name -> providerserverv1.UpdateLinkResourceCompleteResponse
	104, // 75: providerserverv1.UpdateLinkedResourcesResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	112, // 76: providerserverv1.UpdateLinkResourceCompleteResponse.link_data:type_name -> schema.MappingNode
	92,  // 77: providerserverv1.UpdateLinkResourceCompleteResponse.resource_data_mappings:type_name -> providerserverv1.UpdateLinkResourceCompleteResponse.ResourceDataMappingsEntry
	91,  // 78: providerserverv1.UpdateLinkIntermediaryResourcesRequest.link_type:type_name -> providerserverv1.LinkType
	116, // 79: providerserverv1.UpdateLinkIntermediaryResourcesRequest.resource_a_info:type_name -> sharedtypesv1.ResourceInfo
	116, // 80: providerserverv1.UpdateLinkIntermediaryResourcesRequest.resource_b_info:type_name -> sharedtypesv1.ResourceInfo
	115, // 81: providerserverv1.UpdateLinkIntermediaryResourcesRequest.changes:type_name -> sharedtypesv1.LinkChanges
	4,   // 82: providerserverv1.UpdateLinkIntermediaryResourcesRequest.update_type:type_name -> providerserverv1.LinkUpdateType
	76,  // 83: providerserverv1.UpdateLinkIntermediaryResourcesRequest.current_link_state:type_name -> providerserverv1.LinkState
	88,  // 84: providerserverv1.UpdateLinkIntermediaryResourcesRequest.context:type_name -> providerserverv1.LinkContext
	47,  // 85: providerserverv1.UpdateLinkIntermediaryResourcesResponse.complete_response:type_name -> providerserverv1.UpdateLinkIntermediaryResourcesCompleteResponse
	104, // 86: providerserverv1.UpdateLinkIntermediaryResourcesResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	77,  // 87: providerserverv1.UpdateLinkIntermediaryResourcesCompleteResponse.intermediary_resource_states:type_name -> providerserverv1.LinkIntermediaryResourceState
	112, // 88: providerserverv1.UpdateLinkIntermediaryResourcesCompleteResponse.link_data:type_name -> schema.MappingNode
	93,  // 89: providerserverv1.UpdateLinkIntermediaryResourcesCompleteResponse.resource_data_mappings:type_name -> providerserverv1.UpdateLinkIntermediaryResourcesCompleteResponse.ResourceDataMappingsEntry
	73,  // 90: providerserverv1.LinkPriorityResourceResponse.priority_info:type_name -> providerserverv1.LinkPriorityResourceInfo
	104, // 91: providerserverv1.LinkPriorityResourceResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	89,  // 92: providerserverv1.CustomValidateDataSourceRequest.data_source_type:type_name -> providerserverv1.DataSourceType
	117, // 93: providerserverv1.CustomValidateDataSourceRequest.schema_data_source:type_name -> schema.DataSource
	107, // 94: providerserverv1.CustomValidateDataSourceRequest.context:type_name -> sharedtypesv1.ProviderContext
	51,  // 95: providerserverv1.CustomValidateDataSourceResponse.complete_response:type_name -> providerserverv1.CustomValidateDataSourceCompleteResponse
	104, // 96: providerserverv1.CustomValidateDataSourceResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	108, // 97: providerserverv1.CustomValidateDataSourceCompleteResponse.diagnostics:type_name -> sharedtypesv1.Diagnostic
	69,  // 98: providerserverv1.DataSourceSpecDefinitionResponse.spec_definition:type_name -> providerserverv1.DataSourceSpecDefinition
	104, // 99: providerserverv1.DataSourceSpecDefinitionResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	66,  // 100: providerserverv1.DataSourceFilterFieldsResponse.filter_fields:type_name -> providerserverv1.DataSourceFilterFields
	104, // 101: providerserverv1.DataSourceFilterFieldsResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	89,  // 102: providerserverv1.FetchDataSourceRequest.data_source_type:type_name -> providerserverv1.DataSourceType
	62,  // 103: providerserverv1.FetchDataSourceRequest.data_source_with_resolved_subs:type_name -> providerserverv1.ResolvedDataSource
	107, // 104: providerserverv1.FetchDataSourceRequest.context:type_name -> sharedtypesv1.ProviderContext
	61,  // 105: providerserverv1.FetchDataSourceResponse.complete_response:type_name -> providerserverv1.FetchDataSourceCompleteResponse
	104, // 106: providerserverv1.FetchDataSourceResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	57,  // 107: providerserverv1.CustomVariableTypeOptionsResponse.options:type_name -> providerserverv1.CustomVariableTypeOptions
	104, // 108: providerserverv1.CustomVariableTypeOptionsResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	94,  // 109: providerserverv1.CustomVariableTypeOptions.options:type_name -> providerserverv1.CustomVariableTypeOptions.OptionsEntry
	118, // 110: providerserverv1.CustomVariableTypeOption.value:type_name -> schema.ScalarValue
	60,  // 111: providerserverv1.CustomVariableTypeResponse.custom_var_type_info:type_name -> providerserverv1.CustomVariableTypeInfo
	104, // 112: providerserverv1.CustomVariableTypeResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	90,  // 113: providerserverv1.CustomVariableTypeInfo.type:type_name -> providerserverv1.CustomVariableType
	95,  // 114: providerserverv1.FetchDataSourceCompleteResponse.data:type_name -> providerserverv1.FetchDataSourceCompleteResponse.DataEntry
	89,  // 115: providerserverv1.ResolvedDataSource.type:type_name -> providerserverv1.DataSourceType
	63,  // 116: providerserverv1.ResolvedDataSource.data_source_metadata:type_name -> providerserverv1.ResolvedDataSourceMetadata
	64,  // 117: providerserverv1.ResolvedDataSource.filter:type_name -> providerserverv1.ResolvedDataSourceFilter
	96,  // 118: providerserverv1.ResolvedDataSource.exports:type_name -> providerserverv1.ResolvedDataSource.ExportsEntry
	112, // 119: providerserverv1.ResolvedDataSource.description:type_name -> schema.MappingNode
	112, // 120: providerserverv1.ResolvedDataSourceMetadata.display_name:type_name -> schema.MappingNode
	112, // 121: providerserverv1.ResolvedDataSourceMetadata.annotations:type_name -> schema.MappingNode
	112, // 122: providerserverv1.ResolvedDataSourceMetadata.custom:type_name -> schema.MappingNode
	118, // 123: providerserverv1.ResolvedDataSourceFilter.field:type_name -> schema.ScalarValue
	65,  // 124: providerserverv1.ResolvedDataSourceFilter.search:type_name -> providerserverv1.ResolvedDataSourceFilterSearch
	112, // 125: providerserverv1.ResolvedDataSourceFilterSearch.values:type_name -> schema.MappingNode
	97,  // 126: providerserverv1.DataSourceFilterFields.filter_fields:type_name -> providerserverv1.DataSourceFilterFields.FilterFieldsEntry
	118, // 127: providerserverv1.ResolvedDataSourceFieldExport.alias_for:type_name -> schema.ScalarValue
	112, // 128: providerserverv1.ResolvedDataSourceFieldExport.description:type_name -> schema.MappingNode
	98,  // 129: providerserverv1.DataSourceSpecDefinition.fields:type_name -> providerserverv1.DataSourceSpecDefinition.FieldsEntry
	1,   // 130: providerserverv1.DataSourceSpecSchema.type:type_name -> providerserverv1.DataSourceSpecSchemaType
	70,  // 131: providerserverv1.DataSourceSpecSchema.items:type_name -> providerserverv1.DataSourceSpecSchema
	72,  // 132: providerserverv1.DataSourceTypeResponse.data_source_type_info:type_name -> providerserverv1.DataSourceTypeInfo
	104, // 133: providerserverv1.DataSourceTypeResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	89,  // 134: providerserverv1.DataSourceTypeInfo.type:type_name -> providerserverv1.DataSourceType
	2,   // 135: providerserverv1.LinkPriorityResourceInfo.priority_resource:type_name -> providerserverv1.LinkPriorityResource
	105, // 136: providerserverv1.LinkPriorityResourceInfo.priority_resource_type:type_name -> sharedtypesv1.ResourceType
	75,  // 137: providerserverv1.LinkKindResponse.link_kind_info:type_name -> providerserverv1.LinkKindInfo
	104, // 138: providerserverv1.LinkKindResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	3,   // 139: providerserverv1.LinkKindInfo.kind:type_name -> providerserverv1.LinkKind
	5,   // 140: providerserverv1.LinkState.status:type_name -> providerserverv1.LinkStatus
	6,   // 141: providerserverv1.LinkState.precise_status:type_name -> providerserverv1.PreciseLinkStatus
	77,  // 142: providerserverv1.LinkState.intermediary_resource_states:type_name -> providerserverv1.LinkIntermediaryResourceState
	99,  // 143: providerserverv1.LinkState.data:type_name -> providerserverv1.LinkState.DataEntry
	78,  // 144: providerserverv1.LinkState.durations:type_name -> providerserverv1.LinkCompletionDurations
	119, // 145: providerserverv1.LinkIntermediaryResourceState.status:type_name -> sharedtypesv1.ResourceStatus
	120, // 146: providerserverv1.LinkIntermediaryResourceState.precise_status:type_name -> sharedtypesv1.PreciseResourceStatus
	112, // 147: providerserverv1.LinkIntermediaryResourceState.resource_spec_data:type_name -> schema.MappingNode
	79,  // 148: providerserverv1.LinkCompletionDurations.linked_resources_update:type_name -> providerserverv1.LinkComponentCompletionDurations
	79,  // 149: providerserverv1.LinkCompletionDurations.intermediary_resources:type_name -> providerserverv1.LinkComponentCompletionDurations
	121, // 150: providerserverv1.LinkCompletionDurations.total_duration:type_name -> google.protobuf.DoubleValue
	121, // 151: providerserverv1.LinkComponentCompletionDurations.total_duration:type_name -> google.protobuf.DoubleValue
	91,  // 152: providerserverv1.LinkRequest.link_type:type_name -> providerserverv1.LinkType
	88,  // 153: providerserverv1.LinkRequest.context:type_name -> providerserverv1.LinkContext
	91,  // 154: providerserverv1.GetLinkIntermediaryExternalStateRequest.link_type:type_name -> providerserverv1.LinkType
	116, // 155: providerserverv1.GetLinkIntermediaryExternalStateRequest.resource_a_info:type_name -> sharedtypesv1.ResourceInfo
	116, // 156: providerserverv1.GetLinkIntermediaryExternalStateRequest.resource_b_info:type_name -> sharedtypesv1.ResourceInfo
	76,  // 157: providerserverv1.GetLinkIntermediaryExternalStateRequest.current_link_state:type_name -> providerserverv1.LinkState
	88,  // 158: providerserverv1.GetLinkIntermediaryExternalStateRequest.context:type_name -> providerserverv1.LinkContext
	83,  // 159: providerserverv1.GetLinkIntermediaryExternalStateResponse.complete_response:type_name -> providerserverv1.GetLinkIntermediaryExternalStateCompleteResponse
	104, // 160: providerserverv1.GetLinkIntermediaryExternalStateResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	100, // 161: providerserverv1.GetLinkIntermediaryExternalStateCompleteResponse.intermediary_states:type_name -> providerserverv1.GetLinkIntermediaryExternalStateCompleteResponse.IntermediaryStatesEntry
	112, // 162: providerserverv1.ValidateLinkRequest.resource_a_spec:type_name -> schema.MappingNode
	112, // 163: providerserverv1.ValidateLinkRequest.resource_b_spec:type_name -> schema.MappingNode
	105, // 164: providerserverv1.ValidateLinkRequest.resource_a_type:type_name -> sharedtypesv1.ResourceType
	105, // 165: providerserverv1.ValidateLinkRequest.resource_b_type:type_name -> sharedtypesv1.ResourceType
	101, // 166: providerserverv1.ValidateLinkRequest.annotations:type_name -> providerserverv1.ValidateLinkRequest.AnnotationsEntry
	88,  // 167: providerserverv1.ValidateLinkRequest.link_context:type_name -> providerserverv1.LinkContext
	86,  // 168: providerserverv1.ValidateLinkResponse.complete_response:type_name -> providerserverv1.ValidateLinkCompleteResponse
	104, // 169: providerserverv1.ValidateLinkResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	108, // 170: providerserverv1.ValidateLinkCompleteResponse.diagnostics:type_name -> sharedtypesv1.Diagnostic
	112, // 171: providerserverv1.IntermediaryExternalState.spec_data:type_name -> schema.MappingNode
	102, // 172: providerserverv1.LinkContext.provider_config_variables:type_name -> providerserverv1.LinkContext.ProviderConfigVariablesEntry
	103, // 173: providerserverv1.LinkContext.context_variables:type_name -> providerserverv1.LinkContext.ContextVariablesEntry
	58,  // 174: providerserverv1.CustomVariableTypeOptions.OptionsEntry.value:type_name -> providerserverv1.CustomVariableTypeOption
	112, // 175: providerserverv1.FetchDataSourceCompleteResponse.DataEntry.value:type_name -> schema.MappingNode
	68,  // 176: providerserverv1.ResolvedDataSource.ExportsEntry.value:type_name -> providerserverv1.ResolvedDataSourceFieldExport
	67,  // 177: providerserverv1.DataSourceFilterFields.FilterFieldsEntry.value:type_name -> providerserverv1.DataSourceFilterFieldSchema
	70,  // 178: providerserverv1.DataSourceSpecDefinition.FieldsEntry.value:type_name -> providerserverv1.DataSourceSpecSchema
	112, // 179: providerserverv1.LinkState.DataEntry.value:type_name -> schema.MappingNode
	87,  // 180: providerserverv1.GetLinkIntermediaryExternalStateCompleteResponse.IntermediaryStatesEntry.value:type_name -> providerserverv1.IntermediaryExternalState
	118, // 181: providerserverv1.ValidateLinkRequest.AnnotationsEntry.value:type_name -> schema.ScalarValue
	118, // 182: providerserverv1.LinkContext.ProviderConfigVariablesEntry.value:type_name -> schema.ScalarValue
	118, // 183: providerserverv1.LinkContext.ContextVariablesEntry.value:type_name -> schema.ScalarValue
	31,  // 184: providerserverv1.Provider.GetNamespace:input_type -> providerserverv1.ProviderRequest
	31,  // 185: providerserverv1.Provider.GetConfigDefinition:input_type -> providerserverv1.ProviderRequest
	31,  // 186: providerserverv1.Provider.ListResourceTypes:input_type -> providerserverv1.ProviderRequest
	31,  // 187: providerserverv1.Provider.ListLinkTypes:input_type -> providerserverv1.ProviderRequest
	31,  // 188: providerserverv1.Provider.ListDataSourceTypes:input_type -> providerserverv1.ProviderRequest
	31,  // 189: providerserverv1.Provider.ListCustomVariableTypes:input_type -> providerserverv1.ProviderRequest
	31,  // 190: providerserverv1.Provider.ListFunctions:input_type -> providerserverv1.ProviderRequest
	31,  // 191: providerserverv1.Provider.GetRetryPolicy:input_type -> providerserverv1.ProviderRequest
	21,  // 192: providerserverv1.Provider.CustomValidateResource:input_type -> providerserverv1.CustomValidateResourceRequest
	32,  // 193: providerserverv1.Provider.GetResourceSpecDefinition:input_type -> providerserverv1.ResourceRequest
	32,  // 194: providerserverv1.Provider.CanResourceLinkTo:input_type -> providerserverv1.ResourceRequest
	32,  // 195: providerserverv1.Provider.GetResourceStabilisedDeps:input_type -> providerserverv1.ResourceRequest
	32,  // 196: providerserverv1.Provider.IsResourceCommonTerminal:input_type -> providerserverv1.ResourceRequest
	32,  // 197: providerserverv1.Provider.GetResourceType:input_type -> providerserverv1.ResourceRequest
	32,  // 198: providerserverv1.Provider.GetResourceTypeDescription:input_type -> providerserverv1.ResourceRequest
	32,  // 199: providerserverv1.Provider.GetResourceExamples:input_type -> providerserverv1.ResourceRequest
	122, // 200: providerserverv1.Provider.DeployResource:input_type -> sharedtypesv1.DeployResourceRequest
	123, // 201: providerserverv1.Provider.ResourceHasStabilised:input_type -> sharedtypesv1.ResourceHasStabilisedRequest
	29,  // 202: providerserverv1.Provider.GetResourceExternalState:input_type -> providerserverv1.GetResourceExternalStateRequest
	124, // 203: providerserverv1.Provider.DestroyResource:input_type -> sharedtypesv1.DestroyResourceRequest
	35,  // 204: providerserverv1.Provider.StageLinkChanges:input_type -> providerserverv1.StageLinkChangesRequest
	39,  // 205: providerserverv1.Provider.ProduceResourceContributions:input_type -> providerserverv1.ProduceResourceContributionsRequest
	38,  // 206: providerserverv1.Provider.UpdateLinkedResources:input_type -> providerserverv1.UpdateLinkedResourcesRequest
	45,  // 207: providerserverv1.Provider.UpdateLinkIntermediaryResources:input_type -> providerserverv1.UpdateLinkIntermediaryResourcesRequest
	80,  // 208: providerserverv1.Provider.GetLinkPriorityResource:input_type -> providerserverv1.LinkRequest
	80,  // 209: providerserverv1.Provider.GetLinkTypeDescription:input_type -> providerserverv1.LinkRequest
	80,  // 210: providerserverv1.Provider.GetLinkAnnotationDefinitions:input_type -> providerserverv1.LinkRequest
	80,  // 211: providerserverv1.Provider.GetLinkKind:input_type -> providerserverv1.LinkRequest
	81,  // 212: providerserverv1.Provider.GetLinkIntermediaryExternalState:input_type -> providerserverv1.GetLinkIntermediaryExternalStateRequest
	80,  // 213: providerserverv1.Provider.GetLinkCardinality:input_type -> providerserverv1.LinkRequest
	80,  // 214: providerserverv1.Provider.GetLinkCapabilities:input_type -> providerserverv1.LinkRequest
	84,  // 215: providerserverv1.Provider.ValidateLink:input_type -> providerserverv1.ValidateLinkRequest
	33,  // 216: providerserverv1.Provider.GetDataSourceType:input_type -> providerserverv1.DataSourceRequest
	33,  // 217: providerserverv1.Provider.GetDataSourceTypeDescription:input_type -> providerserverv1.DataSourceRequest
	33,  // 218: providerserverv1.Provider.GetDataSourceExamples:input_type -> providerserverv1.DataSourceRequest
	49,  // 219: providerserverv1.Provider.CustomValidateDataSource:input_type -> providerserverv1.CustomValidateDataSourceRequest
	33,  // 220: providerserverv1.Provider.GetDataSourceSpecDefinition:input_type -> providerserverv1.DataSourceRequest
	33,  // 221: providerserverv1.Provider.GetDataSourceFilterFields:input_type -> providerserverv1.DataSourceRequest
	54,  // 222: providerserverv1.Provider.FetchDataSource:input_type -> providerserverv1.FetchDataSourceRequest
	34,  // 223: providerserverv1.Provider.GetCustomVariableType:input_type -> providerserverv1.CustomVariableTypeRequest
	34,  // 224: providerserverv1.Provider.GetCustomVariableTypeDescription:input_type -> providerserverv1.CustomVariableTypeRequest
	34,  // 225: providerserverv1.Provider.GetCustomVariableTypeOptions:input_type -> providerserverv1.CustomVariableTypeRequest
	34,  // 226: providerserverv1.Provider.GetCustomVariableTypeExamples:input_type -> providerserverv1.CustomVariableTypeRequest
	125, // 227: providerserverv1.Provider.GetFunctionDefinition:input_type -> sharedtypesv1.FunctionDefinitionRequest
	126, // 228: providerserverv1.Provider.CallFunction:input_type -> sharedtypesv1.FunctionCallRequest
	7,   // 229: providerserverv1.Provider.GetNamespace:output_type -> providerserverv1.NamespaceResponse
	127, // 230: providerserverv1.Provider.GetConfigDefinition:output_type -> sharedtypesv1.ConfigDefinitionResponse
	9,   // 231: providerserverv1.Provider.ListResourceTypes:output_type -> providerserverv1.ResourceTypesResponse
	11,  // 232: providerserverv1.Provider.ListLinkTypes:output_type -> providerserverv1.LinkTypesResponse
	13,  // 233: providerserverv1.Provider.ListDataSourceTypes:output_type -> providerserverv1.DataSourceTypesResponse
	15,  // 234: providerserverv1.Provider.ListCustomVariableTypes:output_type -> providerserverv1.CustomVariableTypesResponse
	17,  // 235: providerserverv1.Provider.ListFunctions:output_type -> providerserverv1.FunctionListResponse
	19,  // 236: providerserverv1.Provider.GetRetryPolicy:output_type -> providerserverv1.RetryPolicyResponse
	22,  // 237: providerserverv1.Provider.CustomValidateResource:output_type -> providerserverv1.CustomValidateResourceResponse
	24,  // 238: providerserverv1.Provider.GetResourceSpecDefinition:output_type -> providerserverv1.ResourceSpecDefinitionResponse
	25,  // 239: providerserverv1.Provider.CanResourceLinkTo:output_type -> providerserverv1.CanResourceLinkToResponse
	26,  // 240: providerserverv1.Provider.GetResourceStabilisedDeps:output_type -> providerserverv1.ResourceStabilisedDepsResponse
	28,  // 241: providerserverv1.Provider.IsResourceCommonTerminal:output_type -> providerserverv1.IsResourceCommonTerminalResponse
	128, // 242: providerserverv1.Provider.GetResourceType:output_type -> sharedtypesv1.ResourceTypeResponse
	129, // 243: providerserverv1.Provider.GetResourceTypeDescription:output_type -> sharedtypesv1.TypeDescriptionResponse
	130, // 244: providerserverv1.Provider.GetResourceExamples:output_type -> sharedtypesv1.ExamplesResponse
	131, // 245: providerserverv1.Provider.DeployResource:output_type -> sharedtypesv1.DeployResourceResponse
	132, // 246: providerserverv1.Provider.ResourceHasStabilised:output_type -> sharedtypesv1.ResourceHasStabilisedResponse
	30,  // 247: providerserverv1.Provider.GetResourceExternalState:output_type -> providerserverv1.GetResourceExternalStateResponse
	133, // 248: providerserverv1.Provider.DestroyResource:output_type -> sharedtypesv1.DestroyResourceResponse
	36,  // 249: providerserverv1.Provider.StageLinkChanges:output_type -> providerserverv1.StageLinkChangesResponse
	40,  // 250: providerserverv1.Provider.ProduceResourceContributions:output_type -> providerserverv1.ProduceResourceContributionsResponse
	43,  // 251: providerserverv1.Provider.UpdateLinkedResources:output_type -> providerserverv1.UpdateLinkedResourcesResponse
	46,  // 252: providerserverv1.Provider.UpdateLinkIntermediaryResources:output_type -> providerserverv1.UpdateLinkIntermediaryResourcesResponse
	48,  // 253: providerserverv1.Provider.GetLinkPriorityResource:output_type -> providerserverv1.LinkPriorityResourceResponse
	129, // 254: providerserverv1.Provider.GetLinkTypeDescription:output_type -> sharedtypesv1.TypeDescriptionResponse
	134, // 255: providerserverv1.Provider.GetLinkAnnotationDefinitions:output_type -> sharedtypesv1.LinkAnnotationDefinitionsResponse
	74,  // 256: providerserverv1.Provider.GetLinkKind:output_type -> providerserverv1.LinkKindResponse
	82,  // 257: providerserverv1.Provider.GetLinkIntermediaryExternalState:output_type -> providerserverv1.GetLinkIntermediaryExternalStateResponse
	135, // 258: providerserverv1.Provider.GetLinkCardinality:output_type -> sharedtypesv1.LinkCardinalityResponse
	136, // 259: providerserverv1.Provider.GetLinkCapabilities:output_type -> sharedtypesv1.LinkCapabilitiesResponse
	85,  // 260: providerserverv1.Provider.ValidateLink:output_type -> providerserverv1.ValidateLinkResponse
	71,  // 261: providerserverv1.Provider.GetDataSourceType:output_type -> providerserverv1.DataSourceTypeResponse
	129, // 262: providerserverv1.Provider.GetDataSourceTypeDescription:output_type -> sharedtypesv1.TypeDescriptionResponse
	130, // 263: providerserverv1.Provider.GetDataSourceExamples:output_type -> sharedtypesv1.ExamplesResponse
	50,  // 264: providerserverv1.Provider.CustomValidateDataSource:output_type -> providerserverv1.CustomValidateDataSourceResponse
	52,  // 265: providerserverv1.Provider.GetDataSourceSpecDefinition:output_type -> providerserverv1.DataSourceSpecDefinitionResponse
	53,  // 266: providerserverv1.Provider.GetDataSourceFilterFields:output_type -> providerserverv1.DataSourceFilterFieldsResponse
	55,  // 267: providerserverv1.Provider.FetchDataSource:output_type -> providerserverv1.FetchDataSourceResponse
	59,  // 268: providerserverv1.Provider.GetCustomVariableType:output_type -> providerserverv1.CustomVariableTypeResponse
	129, // 269: providerserverv1.Provider.GetCustomVariableTypeDescription:output_type -> sharedtypesv1.TypeDescriptionResponse
	56,  // 270: providerserverv1.Provider.GetCustomVariableTypeOptions:output_type -> providerserverv1.CustomVariableTypeOptionsResponse
	130, // 271: providerserverv1.Provider.GetCustomVariableTypeExamples:output_type -> sharedtypesv1.ExamplesResponse
	137, // 272: providerserverv1.Provider.GetFunctionDefinition:output_type -> sharedtypesv1.FunctionDefinitionResponse
	138, // 273: providerserverv1.Provider.CallFunction:output_type -> sharedtypesv1.FunctionCallResponse
...
func file_plugin_framework_providerserverv1_provider_proto_init() {
	...
	file_plugin_framework_providerserverv1_provider_proto_msgTypes[33].OneofWrappers = []any{
		(*ProduceResourceContributionsResponse_CompleteResponse)(nil),
		(*ProduceResourceContributionsResponse_ErrorResponse)(nil),
	}
	file_plugin_framework_providerserverv1_provider_proto_msgTypes[36].OneofWrappers = []any{
		(*UpdateLinkedResourcesResponse_CompleteResponse)(nil),
		(*UpdateLinkedResourcesResponse_ErrorResponse)(nil),
	}
	...
	file_plugin_framework_providerserverv1_provider_proto_msgTypes[43].OneofWrappers = []any{
	...
	file_plugin_framework_providerserverv1_provider_proto_msgTypes[46].OneofWrappers = []any{
	...
	file_plugin_framework_providerserverv1_provider_proto_msgTypes[49].OneofWrappers = []any{
		(*CustomVariableTypeOptionsResponse_Options)(nil),
		(*CustomVariableTypeOptionsResponse_ErrorResponse)(nil),
	}
	file_plugin_framework_providerserverv1_provider_proto_msgTypes[52].OneofWrappers = []any{
		(*CustomVariableTypeResponse_CustomVarTypeInfo)(nil),
		(*CustomVariableTypeResponse_ErrorResponse)(nil),
	}
	file_plugin_framework_providerserverv1_provider_proto_msgTypes[64].OneofWrappers = []any{
		(*DataSourceTypeResponse_DataSourceTypeInfo)(nil),
		(*DataSourceTypeResponse_ErrorResponse)(nil),
	}
	file_plugin_framework_providerserverv1_provider_proto_msgTypes[67].OneofWrappers = []any{
		(*LinkKindResponse_LinkKindInfo)(nil),
		(*LinkKindResponse_ErrorResponse)(nil),
	}
	file_plugin_framework_providerserverv1_provider_proto_msgTypes[75].OneofWrappers = []any{
		(*GetLinkIntermediaryExternalStateResponse_CompleteResponse)(nil),
		(*GetLinkIntermediaryExternalStateResponse_ErrorResponse)(nil),
	}
	file_plugin_framework_providerserverv1_provider_proto_msgTypes[78].OneofWrappers = []any{
		(*ValidateLinkResponse_CompleteResponse)(nil),
		(*ValidateLinkResponse_ErrorResponse)(nil),
	}
	type x struct{}
