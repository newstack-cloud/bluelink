...
const (
	...
	// The status for when a resource creation was interrupted due to deployment
	...
	ResourceStatus_RESOURCE_STATUS_CREATE_INTERRUPTED ResourceStatus = 13
	// The status for when a resource update was interrupted due to deployment
	// being cancelled (e.g., drain timeout after terminal failure).
	// The actual state of the resource is unknown and needs reconciliation.
	ResourceStatus_RESOURCE_STATUS_UPDATE_INTERRUPTED ResourceStatus = 14
	// The status for when a resource destruction was interrupted due to deployment
	// being cancelled (e.g., drain timeout after terminal failure).
	// The actual state of the resource is unknown and needs reconciliation.
	ResourceStatus_RESOURCE_STATUS_DESTROY_INTERRUPTED ResourceStatus = 15
)
...
var (
	ResourceStatus_name = map[int32]string{
		...
		13: "RESOURCE_STATUS_CREATE_INTERRUPTED",
		14: "RESOURCE_STATUS_UPDATE_INTERRUPTED",
		15: "RESOURCE_STATUS_DESTROY_INTERRUPTED",
	}
	ResourceStatus_value = map[string]int32{
		...
		"RESOURCE_STATUS_CREATE_INTERRUPTED":  13,
		"RESOURCE_STATUS_UPDATE_INTERRUPTED":  14,
		"RESOURCE_STATUS_DESTROY_INTERRUPTED": 15,
	}
)
...
const (
	...
	// being cancelled (e.g., drain timeout after terminal failure).
	// The actual state of the resource is unknown and needs reconciliation.
	PreciseResourceStatus_PRECISE_RESOURCE_STATUS_CREATE_INTERRUPTED PreciseResourceStatus = 23
	// The status for when a resource update was interrupted due to deployment
	// being cancelled (e.g., drain timeout after terminal failure).
	// The actual state of the resource is unknown and needs reconciliation.
	PreciseResourceStatus_PRECISE_RESOURCE_STATUS_UPDATE_INTERRUPTED PreciseResourceStatus = 24
	// The status for when a resource destruction was interrupted due to deployment
	// being cancelled (e.g., drain timeout after terminal failure).
	// The actual state of the resource is unknown and needs reconciliation.
	PreciseResourceStatus_PRECISE_RESOURCE_STATUS_DESTROY_INTERRUPTED PreciseResourceStatus = 25
)
...
var (
	PreciseResourceStatus_name = map[int32]string{
		...
		23: "PRECISE_RESOURCE_STATUS_CREATE_INTERRUPTED",
		24: "PRECISE_RESOURCE_STATUS_UPDATE_INTERRUPTED",
		25: "PRECISE_RESOURCE_STATUS_DESTROY_INTERRUPTED",
	}
	PreciseResourceStatus_value = map[string]int32{
		...
		"PRECISE_RESOURCE_STATUS_CREATE_INTERRUPTED":               23,
		"PRECISE_RESOURCE_STATUS_UPDATE_INTERRUPTED":               24,
		"PRECISE_RESOURCE_STATUS_DESTROY_INTERRUPTED":              25,
	}
)
...
type TaggingSupport int32

const (
	// The resource type does not support tags.
	// Provenance will be stored in Bluelink state only.
	TaggingSupport_TAGGING_SUPPORT_NONE TaggingSupport = 0
	// The resource supports arbitrary key-value tags (AWS, Azure).
	TaggingSupport_TAGGING_SUPPORT_FULL TaggingSupport = 1
	// The resource supports labels with restrictions (GCP, K8s).
	TaggingSupport_TAGGING_SUPPORT_LABELS TaggingSupport = 2
)

// Enum value maps for TaggingSupport.
var (
	TaggingSupport_name = map[int32]string{
		0: "TAGGING_SUPPORT_NONE",
		1: "TAGGING_SUPPORT_FULL",
		2: "TAGGING_SUPPORT_LABELS",
	}
	TaggingSupport_value = map[string]int32{
		"TAGGING_SUPPORT_NONE":   0,
		"TAGGING_SUPPORT_FULL":   1,
		"TAGGING_SUPPORT_LABELS": 2,
	}
)

func (x TaggingSupport) Enum() *TaggingSupport {
	p := new(TaggingSupport)
	*p = x
	return p
}

func (x TaggingSupport) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TaggingSupport) Descriptor() protoreflect.EnumDescriptor {
	return file_plugin_framework_sharedtypesv1_types_proto_enumTypes[6].Descriptor()
}

func (TaggingSupport) Type() protoreflect.EnumType {
	return &file_plugin_framework_sharedtypesv1_types_proto_enumTypes[6]
}

func (x TaggingSupport) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TaggingSupport.Descriptor instead.
func (TaggingSupport) EnumDescriptor() ([]byte, []int) {
...
func (ErrorCode) Descriptor() protoreflect.EnumDescriptor {
	return file_plugin_framework_sharedtypesv1_types_proto_enumTypes[7].Descriptor()
}

func (ErrorCode) Type() protoreflect.EnumType {
	return &file_plugin_framework_sharedtypesv1_types_proto_enumTypes[7]
}
...
type ResourceHasStabilisedRequest struct {
	...
	// Whether the check follows a link writing the resource rather than the engine
	// deploying it. The two are different questions. After a deployment, it is whether the
	// operation the engine started has finished; after a link's write, it is whether the
	// resource is settled in the provider, which the engine has no handle on.
	//
	// Absent on a plugin built before this field existed, which decodes as false and
	// keeps the behaviour those plugins already have.
	AfterLinkUpdate bool `protobuf:"varint,9,opt,name=after_link_update,json=afterLinkUpdate" json:"after_link_update,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *ResourceHasStabilisedRequest) GetAfterLinkUpdate() bool {
	if x != nil {
		return x.AfterLinkUpdate
	}
	return false
}
...
type ResourceStabilisationInfo struct {
	...
	// Computed field values that only become available once the resource has
	// finished provisioning (e.g. an endpoint address). These are merged into the
	// persisted resource state when the resource reports it has stabilised.
	ComputedFieldValues map[string]*schemapb.MappingNode `protobuf:"bytes,2,rep,name=computed_field_values,json=computedFieldValues" json:"computed_field_values,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *ResourceStabilisationInfo) GetComputedFieldValues() map[string]*schemapb.MappingNode {
	if x != nil {
		return x.ComputedFieldValues
	}
	return nil
...
type Changes struct {
	...
	// A mapping of a resource spec field path to the logical name of the link
	// that contributes the value at that path.
	// A link writes fields that the blueprint does not declare, so a change to
	// one of them cannot be explained by reading the blueprint. The field paths
	// appear in modified_fields, new_fields and removed_fields like any other,
	// and this says which link each one belongs to.
	LinkOwnedFields map[string]string `protobuf:"bytes,13,rep,name=link_owned_fields,json=linkOwnedFields" json:"link_owned_fields,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// Contributions a link records against this resource that could not be composed
	// into its spec. Each one is a field the deployed resource holds that the change
	// set could not account for, so deploying without resolving it removes that field.
	UnappliedLinkFields []*UnappliedLinkField `protobuf:"bytes,14,rep,name=unapplied_link_fields,json=unappliedLinkFields" json:"unapplied_link_fields,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *Changes) GetLinkOwnedFields() map[string]string {
	if x != nil {
		return x.LinkOwnedFields
	}
	return nil
}

func (x *Changes) GetUnappliedLinkFields() []*UnappliedLinkField {
	if x != nil {
		return x.UnappliedLinkFields
	}
	return nil
}
...
type LinkChanges struct {
	...
	// The resource fields the link will contribute to, mapped to the path in the link's
	// data that each field's value will be read from.
	//
	// Keys take the "{resourceName}::{fieldPath}" form the link goes on to return once it
	// has run, declared ahead of time and without the values, which are not known until
	// both endpoints have deployed.
	ResourceDataMappings map[string]string `protobuf:"bytes,6,rep,name=resource_data_mappings,json=resourceDataMappings" json:"resource_data_mappings,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *LinkChanges) GetResourceDataMappings() map[string]string {
	if x != nil {
...
type ResourceState struct {
	...
	// System-generated metadata for the resource including provenance information.
	SystemMetadata *SystemMetadataState `protobuf:"bytes,20,opt,name=system_metadata,json=systemMetadata" json:"system_metadata,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *ResourceState) GetSystemMetadata() *SystemMetadataState {
	if x != nil {
...
type SystemMetadataState struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Provenance information for the resource.
	Provenance    *ProvenanceState `protobuf:"bytes,1,opt,name=provenance" json:"provenance,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SystemMetadataState) Reset() {
	*x = SystemMetadataState{}
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[63]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SystemMetadataState) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SystemMetadataState) ProtoMessage() {}

func (x *SystemMetadataState) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[63]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SystemMetadataState.ProtoReflect.Descriptor instead.
func (*SystemMetadataState) Descriptor() ([]byte, []int) {
	return file_plugin_framework_sharedtypesv1_types_proto_rawDescGZIP(), []int{63}
}

func (x *SystemMetadataState) GetProvenance() *ProvenanceState {
	if x != nil {
		return x.Provenance
	}
	return nil
...
type ProvenanceState struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// A marker indicating the resource was provisioned by Bluelink.
	ProvisionedBy string `protobuf:"bytes,1,opt,name=provisioned_by,json=provisionedBy" json:"provisioned_by,omitempty"`
	// The version of the deploy engine that provisioned the resource.
	DeployEngineVersion string `protobuf:"bytes,2,opt,name=deploy_engine_version,json=deployEngineVersion" json:"deploy_engine_version,omitempty"`
	// The identifier for the provider plugin (e.g., "newstack-cloud/aws").
	ProviderPluginId string `protobuf:"bytes,3,opt,name=provider_plugin_id,json=providerPluginId" json:"provider_plugin_id,omitempty"`
	// The version of the provider plugin that provisioned the resource.
	ProviderPluginVersion string `protobuf:"bytes,4,opt,name=provider_plugin_version,json=providerPluginVersion" json:"provider_plugin_version,omitempty"`
	// The unix timestamp when the resource was provisioned.
	ProvisionedAt int64 `protobuf:"varint,5,opt,name=provisioned_at,json=provisionedAt" json:"provisioned_at,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ProvenanceState) Reset() {
	*x = ProvenanceState{}
...
func (x *ProvenanceState) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProvenanceState) ProtoMessage() {}

func (x *ProvenanceState) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[64]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProvenanceState.ProtoReflect.Descriptor instead.
func (*ProvenanceState) Descriptor() ([]byte, []int) {
	return file_plugin_framework_sharedtypesv1_types_proto_rawDescGZIP(), []int{64}
}

func (x *ProvenanceState) GetProvisionedBy() string {
	if x != nil {
		return x.ProvisionedBy
	}
	return ""
}

func (x *ProvenanceState) GetDeployEngineVersion() string {
	if x != nil {
		return x.DeployEngineVersion
	}
	return ""
}

func (x *ProvenanceState) GetProviderPluginId() string {
	if x != nil {
...
func (x *ProvenanceState) GetProviderPluginVersion() string {
	if x != nil {
...
func (x *ProvenanceState) GetProvisionedAt() int64 {
	if x != nil {
...
type ResourceSpecDefinition struct {
	...
	// Indicates how the resource type supports external tagging.
	TaggingSupport TaggingSupport `protobuf:"varint,4,opt,name=tagging_support,json=taggingSupport,enum=sharedtypesv1.TaggingSupport" json:"tagging_support,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *ResourceSpecDefinition) GetDestroyBeforeCreate() bool {
	if x != nil {
		return x.DestroyBeforeCreate
	}
	return false
}

func (x *ResourceSpecDefinition) GetTaggingSupport() TaggingSupport {
	if x != nil {
		return x.TaggingSupport
	}
	return TaggingSupport_TAGGING_SUPPORT_NONE
}
...
type ResourceDefinitionsSchema struct {
	...
	// Specifies a field name to sort array items by before comparison.
	...
	// setting sort_array_by_field to "key" ensures consistent comparison regardless of order.
	SortArrayByField string `protobuf:"bytes,18,opt,name=sort_array_by_field,json=sortArrayByField" json:"sort_array_by_field,omitempty"`
	// Holds a list of allowed values for a resource definition schema.
	...
	// value constraints.
	AllowedValues []*schemapb.MappingNode `protobuf:"bytes,19,rep,name=allowed_values,json=allowedValues" json:"allowed_values,omitempty"`
	// Holds the minimum value that can be used for an element in a resource spec.
	// This is only used for "integer" and "float" types.
	Minimum *schemapb.ScalarValue `protobuf:"bytes,20,opt,name=minimum" json:"minimum,omitempty"`
	// Holds the maximum value that can be used for an element in a resource spec.
	// This is only used for "integer" and "float" types.
	Maximum *schemapb.ScalarValue `protobuf:"bytes,21,opt,name=maximum" json:"maximum,omitempty"`
	// Provides a minimum length for a string value, minimum amount of items
	// in an array or minimum number of keys in a map.
	// This is only used for "string", "array" and "map" types.
	MinLength int32 `protobuf:"varint,22,opt,name=min_length,json=minLength" json:"min_length,omitempty"`
	// Provides a maximum length for a string value, maximum amount of items
	// in an array or maximum number of keys in a map.
	// This is only used for "string", "array" and "map" types.
	MaxLength int32 `protobuf:"varint,23,opt,name=max_length,json=maxLength" json:"max_length,omitempty"`
	// Holds a regular expression pattern that can be used to validate
	// a string value in a resource spec that uses this schema.
	// This is only used for "string" types.
	Pattern string `protobuf:"bytes,24,opt,name=pattern" json:"pattern,omitempty"`
	// Marks this field as a "wiring slot": placing a reference to another
	// resource here activates a registered link between the two resource types
	// without requiring a linkSelector.
	ActivatesLinkOnReference bool `protobuf:"varint,25,opt,name=activates_link_on_reference,json=activatesLinkOnReference" json:"activates_link_on_reference,omitempty"`
	// Specifies that the user may set the value, but when it is omitted from
	// a blueprint the provider computes it during deployment (for example, an
	// auto-generated resource name that doubles as the resource's identifier).
	...
	ComputedWhenOmitted bool `protobuf:"varint,26,opt,name=computed_when_omitted,json=computedWhenOmitted" json:"computed_when_omitted,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *ResourceDefinitionsSchema) GetSortArrayByField() string {
	if x != nil {
		return x.SortArrayByField
	}
	return ""
}

func (x *ResourceDefinitionsSchema) GetAllowedValues() []*schemapb.MappingNode {
	if x != nil {
		return x.AllowedValues
	}
	return nil
...
func (x *ResourceDefinitionsSchema) GetMinimum() *schemapb.ScalarValue {
	if x != nil {
		return x.Minimum
	}
	return nil
...
func (x *ResourceDefinitionsSchema) GetMaximum() *schemapb.ScalarValue {
	if x != nil {
		return x.Maximum
	}
	return nil
...
func (x *ResourceDefinitionsSchema) GetMinLength() int32 {
	if x != nil {
		return x.MinLength
	}
	return 0
...
func (x *ResourceDefinitionsSchema) GetMaxLength() int32 {
	if x != nil {
		return x.MaxLength
	}
	return 0
...
func (x *ResourceDefinitionsSchema) GetPattern() string {
	if x != nil {
		return x.Pattern
	}
	return ""
...
func (x *ResourceDefinitionsSchema) GetActivatesLinkOnReference() bool {
	if x != nil {
		return x.ActivatesLinkOnReference
	}
	return false
}

func (x *ResourceDefinitionsSchema) GetComputedWhenOmitted() bool {
	if x != nil {
		return x.ComputedWhenOmitted
	}
	return false
}
...
// DiagnosticSuggestedAction holds a suggested action that the user can take
// in response to an error diagnostic.
...
func (x *ResourceType) Reset() {
	*x = ResourceType{}
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[73]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ResourceType) Descriptor() ([]byte, []int) {
	return file_plugin_framework_sharedtypesv1_types_proto_rawDescGZIP(), []int{73}
}
...
type ProviderContext struct {
	...
	TaggingConfig *TaggingConfig `protobuf:"bytes,3,opt,name=tagging_config,json=taggingConfig" json:"tagging_config,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ProviderContext) Reset() {
	*x = ProviderContext{}
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[74]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProviderContext) Descriptor() ([]byte, []int) {
	return file_plugin_framework_sharedtypesv1_types_proto_rawDescGZIP(), []int{74}
}
...
func (x *ProviderContext) GetTaggingConfig() *TaggingConfig {
	if x != nil {
		return x.TaggingConfig
	}
	return nil
}
...
type TaggingConfig struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The prefix to apply to all Bluelink tag keys.
	// Default is "bluelink:".
	Prefix string `protobuf:"bytes,1,opt,name=prefix" json:"prefix,omitempty"`
	// The version of the deploy engine.
	DeployEngineVersion string `protobuf:"bytes,2,opt,name=deploy_engine_version,json=deployEngineVersion" json:"deploy_engine_version,omitempty"`
	// The identifier for the provider plugin (e.g., "newstack-cloud/aws").
	ProviderPluginId string `protobuf:"bytes,3,opt,name=provider_plugin_id,json=providerPluginId" json:"provider_plugin_id,omitempty"`
	// The version of the provider plugin.
	ProviderPluginVersion string `protobuf:"bytes,4,opt,name=provider_plugin_version,json=providerPluginVersion" json:"provider_plugin_version,omitempty"`
	// Controls whether tagging is enabled.
	Enabled       bool `protobuf:"varint,5,opt,name=enabled" json:"enabled,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TaggingConfig) Reset() {
	*x = TaggingConfig{}
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[75]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TaggingConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TaggingConfig) ProtoMessage() {}

func (x *TaggingConfig) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[75]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TaggingConfig.ProtoReflect.Descriptor instead.
func (*TaggingConfig) Descriptor() ([]byte, []int) {
	return file_plugin_framework_sharedtypesv1_types_proto_rawDescGZIP(), []int{75}
}

func (x *TaggingConfig) GetPrefix() string {
	if x != nil {
		return x.Prefix
	}
	return ""
...
func (x *TaggingConfig) GetDeployEngineVersion() string {
	if x != nil {
		return x.DeployEngineVersion
	}
	return ""
...
func (x *TaggingConfig) GetProviderPluginId() string {
	if x != nil {
		return x.ProviderPluginId
	}
	return ""
...
func (x *TaggingConfig) GetProviderPluginVersion() string {
	if x != nil {
		return x.ProviderPluginVersion
	}
	return ""
...
func (x *TaggingConfig) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *BlueprintParams) Reset() {
	*x = BlueprintParams{}
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[76]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BlueprintParams) Descriptor() ([]byte, []int) {
	return file_plugin_framework_sharedtypesv1_types_proto_rawDescGZIP(), []int{76}
}
...
func (x *LinkAnnotationDefinitionsResponse) Reset() {
	*x = LinkAnnotationDefinitionsResponse{}
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[77]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LinkAnnotationDefinitionsResponse) Descriptor() ([]byte, []int) {
	return file_plugin_framework_sharedtypesv1_types_proto_rawDescGZIP(), []int{77}
}
...
func (x *LinkAnnotationDefinitionsResponse) GetErrorResponse() *ErrorResponse {
	if x != nil {
...
func (x *LinkAnnotationDefinitions) Reset() {
	*x = LinkAnnotationDefinitions{}
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[78]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LinkAnnotationDefinitions) Descriptor() ([]byte, []int) {
	return file_plugin_framework_sharedtypesv1_types_proto_rawDescGZIP(), []int{78}
}
...
type LinkAnnotationDefinition struct {
	...
	Name          string                  `protobuf:"bytes,1,opt,name=name" json:"name,omitempty"`
	Label         string                  `protobuf:"bytes,2,opt,name=label" json:"label,omitempty"`
	Type          ScalarType              `protobuf:"varint,3,opt,name=type,enum=sharedtypesv1.ScalarType" json:"type,omitempty"`
	Description   string                  `protobuf:"bytes,4,opt,name=description" json:"description,omitempty"`
	...
	// 0 = Any (default), 1 = ResourceA, 2 = ResourceB
	AppliesTo     int32 `protobuf:"varint,9,opt,name=applies_to,json=appliesTo" json:"applies_to,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LinkAnnotationDefinition) Reset() {
	*x = LinkAnnotationDefinition{}
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[79]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LinkAnnotationDefinition) Descriptor() ([]byte, []int) {
	return file_plugin_framework_sharedtypesv1_types_proto_rawDescGZIP(), []int{79}
}
...
func (x *LinkAnnotationDefinition) GetType() ScalarType {
	if x != nil {
		return x.Type
	}
	return ScalarType_SCALAR_TYPE_STRING
...
func (x *LinkAnnotationDefinition) GetAppliesTo() int32 {
	if x != nil {
		return x.AppliesTo
	}
	return 0
...
// LinkCardinalityResponse is the response containing the cardinality for a link type.
type LinkCardinalityResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Response:
	//
	//	*LinkCardinalityResponse_CardinalityInfo
	//	*LinkCardinalityResponse_ErrorResponse
	Response      isLinkCardinalityResponse_Response `protobuf_oneof:"response"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *LinkCardinalityResponse) Reset() {
	*x = LinkCardinalityResponse{}
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[80]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *LinkCardinalityResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LinkCardinalityResponse) ProtoMessage() {}

func (x *LinkCardinalityResponse) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[80]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LinkCardinalityResponse.ProtoReflect.Descriptor instead.
func (*LinkCardinalityResponse) Descriptor() ([]byte, []int) {
	return file_plugin_framework_sharedtypesv1_types_proto_rawDescGZIP(), []int{80}
}

func (x *LinkCardinalityResponse) GetResponse() isLinkCardinalityResponse_Response {
	if x != nil {
		return x.Response
	}
	return nil
...
func (x *LinkCardinalityResponse) GetCardinalityInfo() *LinkCardinalityInfo {
	if x != nil {
		if x, ok := x.Response.(*LinkCardinalityResponse_CardinalityInfo); ok {
			return x.CardinalityInfo
		}
	}
	return nil
}

func (x *LinkCardinalityResponse) GetErrorResponse() *ErrorResponse {
	if x != nil {
		if x, ok := x.Response.(*LinkCardinalityResponse_ErrorResponse); ok {
			return x.ErrorResponse
		}
	}
	return nil
...
type isLinkCardinalityResponse_Response interface {
	isLinkCardinalityResponse_Response()
}

type LinkCardinalityResponse_CardinalityInfo struct {
	CardinalityInfo *LinkCardinalityInfo `protobuf:"bytes,1,opt,name=cardinality_info,json=cardinalityInfo,oneof"`
}

type LinkCardinalityResponse_ErrorResponse struct {
	ErrorResponse *ErrorResponse `protobuf:"bytes,2,opt,name=error_response,json=errorResponse,oneof"`
}

func (*LinkCardinalityResponse_CardinalityInfo) isLinkCardinalityResponse_Response() {}

func (*LinkCardinalityResponse_ErrorResponse) isLinkCardinalityResponse_Response() {}

// LinkCardinalityInfo provides the cardinality information for a link type.
type LinkCardinalityInfo struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	CardinalityA  *LinkItemCardinality   `protobuf:"bytes,1,opt,name=cardinality_a,json=cardinalityA" json:"cardinality_a,omitempty"`
	CardinalityB  *LinkItemCardinality   `protobuf:"bytes,2,opt,name=cardinality_b,json=cardinalityB" json:"cardinality_b,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *LinkCardinalityInfo) Reset() {
	*x = LinkCardinalityInfo{}
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[81]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *LinkCardinalityInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LinkCardinalityInfo) ProtoMessage() {}

func (x *LinkCardinalityInfo) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[81]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LinkCardinalityInfo.ProtoReflect.Descriptor instead.
func (*LinkCardinalityInfo) Descriptor() ([]byte, []int) {
	return file_plugin_framework_sharedtypesv1_types_proto_rawDescGZIP(), []int{81}
}

func (x *LinkCardinalityInfo) GetCardinalityA() *LinkItemCardinality {
	if x != nil {
		return x.CardinalityA
	}
	return nil
}

func (x *LinkCardinalityInfo) GetCardinalityB() *LinkItemCardinality {
	if x != nil {
		return x.CardinalityB
	}
	return nil
}

// LinkCapabilitiesResponse is the response containing the capabilities
// a link provides and requires.
type LinkCapabilitiesResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Response:
	//
	//	*LinkCapabilitiesResponse_CapabilitiesInfo
	//	*LinkCapabilitiesResponse_ErrorResponse
	Response      isLinkCapabilitiesResponse_Response `protobuf_oneof:"response"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *LinkCapabilitiesResponse) Reset() {
	*x = LinkCapabilitiesResponse{}
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[82]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *LinkCapabilitiesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LinkCapabilitiesResponse) ProtoMessage() {}

func (x *LinkCapabilitiesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[82]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LinkCapabilitiesResponse.ProtoReflect.Descriptor instead.
func (*LinkCapabilitiesResponse) Descriptor() ([]byte, []int) {
	return file_plugin_framework_sharedtypesv1_types_proto_rawDescGZIP(), []int{82}
}

func (x *LinkCapabilitiesResponse) GetResponse() isLinkCapabilitiesResponse_Response {
	if x != nil {
		return x.Response
	}
	return nil
...
func (x *LinkCapabilitiesResponse) GetCapabilitiesInfo() *LinkCapabilitiesInfo {
	if x != nil {
		if x, ok := x.Response.(*LinkCapabilitiesResponse_CapabilitiesInfo); ok {
			return x.CapabilitiesInfo
		}
	}
	return nil
}

func (x *LinkCapabilitiesResponse) GetErrorResponse() *ErrorResponse {
	if x != nil {
		if x, ok := x.Response.(*LinkCapabilitiesResponse_ErrorResponse); ok {
			return x.ErrorResponse
		}
	}
	return nil
...
type isLinkCapabilitiesResponse_Response interface {
	isLinkCapabilitiesResponse_Response()
}

type LinkCapabilitiesResponse_CapabilitiesInfo struct {
	CapabilitiesInfo *LinkCapabilitiesInfo `protobuf:"bytes,1,opt,name=capabilities_info,json=capabilitiesInfo,oneof"`
}

type LinkCapabilitiesResponse_ErrorResponse struct {
	ErrorResponse *ErrorResponse `protobuf:"bytes,2,opt,name=error_response,json=errorResponse,oneof"`
}

func (*LinkCapabilitiesResponse_CapabilitiesInfo) isLinkCapabilitiesResponse_Response() {}

func (*LinkCapabilitiesResponse_ErrorResponse) isLinkCapabilitiesResponse_Response() {}

// LinkCapabilitiesInfo provides the guarantees a link establishes about the resources
// in its relationship, and the guarantees it needs established before it runs.
type LinkCapabilitiesInfo struct {
	state    protoimpl.MessageState `protogen:"open.v1"`
	Provides []*LinkCapability      `protobuf:"bytes,1,rep,name=provides" json:"provides,omitempty"`
	Requires []*LinkCapability      `protobuf:"bytes,2,rep,name=requires" json:"requires,omitempty"`
	// Which resources in the relationship the link writes to.
	// 0 = both, 1 = ResourceA only, 2 = ResourceB only, 3 = neither.
	//
	// Both is the zero value on purpose. A plugin built before this field existed
	// sends nothing, which decodes as both and keeps the behaviour the engine had
	// before links could declare this. Over-declaring costs throughput, while
	// under-declaring lets two links write one resource at the same time, so the
	// value that means "assume nothing" has to be the cautious one.
	Modifies      int32 `protobuf:"varint,3,opt,name=modifies" json:"modifies,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *LinkCapabilitiesInfo) Reset() {
	*x = LinkCapabilitiesInfo{}
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[83]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *LinkCapabilitiesInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LinkCapabilitiesInfo) ProtoMessage() {}

func (x *LinkCapabilitiesInfo) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[83]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LinkCapabilitiesInfo.ProtoReflect.Descriptor instead.
func (*LinkCapabilitiesInfo) Descriptor() ([]byte, []int) {
	return file_plugin_framework_sharedtypesv1_types_proto_rawDescGZIP(), []int{83}
}

func (x *LinkCapabilitiesInfo) GetProvides() []*LinkCapability {
	if x != nil {
		return x.Provides
	}
	return nil
...
func (x *LinkCapabilitiesInfo) GetRequires() []*LinkCapability {
	if x != nil {
		return x.Requires
	}
	return nil
...
func (x *LinkCapabilitiesInfo) GetModifies() int32 {
	if x != nil {
		return x.Modifies
	}
	return 0
...
// relationship, used to order link deployment.
type LinkCapability struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// A stable, provider-namespaced identifier for the guarantee,
	// e.g. "aws.flexvpc/network-attached".
	Name string `protobuf:"bytes,1,opt,name=name" json:"name,omitempty"`
	// Which resource in the relationship the capability applies to.
	// 1 = ResourceA, 2 = ResourceB. Any other value leaves the capability
	// unmatched and so undeclared.
	Resource int32 `protobuf:"varint,2,opt,name=resource" json:"resource,omitempty"`
	// Marks a requirement the link cannot function without. Meaningless on a
	// capability listed under provides.
	MustExist     bool `protobuf:"varint,3,opt,name=must_exist,json=mustExist" json:"must_exist,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *LinkCapability) Reset() {
	*x = LinkCapability{}
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[84]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *LinkCapability) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LinkCapability) ProtoMessage() {}

func (x *LinkCapability) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[84]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LinkCapability.ProtoReflect.Descriptor instead.
func (*LinkCapability) Descriptor() ([]byte, []int) {
	return file_plugin_framework_sharedtypesv1_types_proto_rawDescGZIP(), []int{84}
}

func (x *LinkCapability) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *LinkCapability) GetResource() int32 {
	if x != nil {
		return x.Resource
	}
	return 0
...
func (x *LinkCapability) GetMustExist() bool {
	if x != nil {
		return x.MustExist
	}
	return false
...
// LinkItemCardinality provides the cardinality for an item in a link relationship
// in relation to the other item in the link.
type LinkItemCardinality struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The minimum number of links that can exist between a pair of resource types.
	// 0 means no minimum.
	Min int32 `protobuf:"varint,1,opt,name=min" json:"min,omitempty"`
	// The maximum number of links that can exist between a pair of resource types.
	// 0 means unlimited.
...
func (x *LinkItemCardinality) Reset() {
	*x = LinkItemCardinality{}
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[85]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *LinkItemCardinality) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LinkItemCardinality) ProtoMessage() {}

func (x *LinkItemCardinality) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[85]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LinkItemCardinality.ProtoReflect.Descriptor instead.
func (*LinkItemCardinality) Descriptor() ([]byte, []int) {
	return file_plugin_framework_sharedtypesv1_types_proto_rawDescGZIP(), []int{85}
}

func (x *LinkItemCardinality) GetMin() int32 {
	if x != nil {
		return x.Min
	}
	return 0
...
func (x *LinkItemCardinality) GetMax() int32 {
	if x != nil {
		return x.Max
	}
	return 0
...
func (x *ErrorResponse) Reset() {
	*x = ErrorResponse{}
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[86]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ErrorResponse) Descriptor() ([]byte, []int) {
	return file_plugin_framework_sharedtypesv1_types_proto_rawDescGZIP(), []int{86}
}
...
// UnappliedLinkField is a contribution a link records against a resource that could
// not be composed into the resource's spec, reported so that the field the deployed
// resource holds is not silently absent from the change set.
type UnappliedLinkField struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The logical name of the link that owns the field.
	LinkName string `protobuf:"bytes,1,opt,name=link_name,json=linkName" json:"link_name,omitempty"`
	// The path in the resource spec the link owns.
	FieldPath string `protobuf:"bytes,2,opt,name=field_path,json=fieldPath" json:"field_path,omitempty"`
	// Why the contribution could not be composed.
	Reason        string `protobuf:"bytes,3,opt,name=reason" json:"reason,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UnappliedLinkField) Reset() {
	*x = UnappliedLinkField{}
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[87]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UnappliedLinkField) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UnappliedLinkField) ProtoMessage() {}

func (x *UnappliedLinkField) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_framework_sharedtypesv1_types_proto_msgTypes[87]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UnappliedLinkField.ProtoReflect.Descriptor instead.
func (*UnappliedLinkField) Descriptor() ([]byte, []int) {
	return file_plugin_framework_sharedtypesv1_types_proto_rawDescGZIP(), []int{87}
}

func (x *UnappliedLinkField) GetLinkName() string {
	if x != nil {
		return x.LinkName
	}
	return ""
...
func (x *UnappliedLinkField) GetFieldPath() string {
	if x != nil {
		return x.FieldPath
	}
	return ""
...
func (x *UnappliedLinkField) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
var file_plugin_framework_sharedtypesv1_types_proto_rawDesc = string([]byte{
	...
	0x02, 0x38, 0x01, 0x22, 0xd3, 0x03, 0x0a, 0x1c, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	,
	...
	0x0a, 0x08, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xd9, 0x02, 0x0a, 0x16, 0x44,
	...
	0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x73,
	...
	0x72, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x68, 0x6f, 0x73, 0x74, 0x5f,
	0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x68, 0x6f, 0x73, 0x74, 0x49, 0x64,
	...
	0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72,
	...
	0x1c, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x74, 0x79, 0x70, 0x65, 0x73, 0x76, 0x31, 0x2e,
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x0d, 0x72,
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x38, 0x0a, 0x07,
	0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e,
	...
	0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x22, 0xac, 0x01, 0x0a, 0x17, 0x44, 0x65, 0x73, 0x74, 0x72,
	0x6f, 0x79, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x12, 0x3e, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x24, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x74, 0x79, 0x70, 0x65, 0x73,
	0x76, 0x31, 0x2e, 0x44, 0x65, 0x73, 0x74, 0x72, 0x6f, 0x79, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x48, 0x00, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75,
	0x6c, 0x74, 0x12, 0x45, 0x0a, 0x0e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x5f, 0x72, 0x65, 0x73, 0x70,
	...
	,
	...
	,
	...
	0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x73, 0x68, 0x61, 0x72,
	0x65, 0x64, 0x74, 0x79, 0x70, 0x65, 0x73, 0x76, 0x31, 0x2e, 0x4c, 0x69, 0x6e, 0x6b, 0x43, 0x68,
	0x61, 0x6e, 0x67, 0x65, 0x73, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01,
	0x1a, 0x62, 0x0a, 0x18, 0x4f, 0x75, 0x74, 0x62, 0x6f, 0x75, 0x6e, 0x64, 0x4c, 0x69, 0x6e, 0x6b,
	...
	0x6e, 0x6b, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65,
	0x3a, 0x02, 0x38, 0x01, 0x1a, 0x42, 0x0a, 0x14, 0x4c, 0x69, 0x6e, 0x6b, 0x4f, 0x77, 0x6e, 0x65,
	0x64, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03,
	0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14,
	0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76,
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xd5, 0x01, 0x0a, 0x0b, 0x46, 0x69, 0x65,
	...
	0x65, 0x6c, 0x64, 0x50, 0x61, 0x74, 0x68, 0x12, 0x32, 0x0a, 0x0a, 0x70, 0x72, 0x65, 0x76, 0x5f,
	...
	,
	...
	0x12, 0x1f, 0x0a, 0x0b, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x49,
	0x64, 0x12, 0x52, 0x0a, 0x16, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x5f, 0x72, 0x65, 0x73,
	...
	,
	...
	0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x74, 0x79,
	...
	0x70, 0x72, 0x65, 0x63, 0x69, 0x73, 0x65, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x07,
	...
	,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x43, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x74,
	0x79, 0x70, 0x65, 0x73, 0x76, 0x31, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x76, 0x65, 0x64, 0x52,
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x52,
	0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x46, 0x0a, 0x09, 0x63, 0x6f, 0x6e,
	0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x73,
	0x68, 0x61, 0x72, 0x65, 0x64, 0x74, 0x79, 0x70, 0x65, 0x73, 0x76, 0x31, 0x2e, 0x52, 0x65, 0x73,
	...
	0x6e, 0x12, 0x39, 0x0a, 0x0d, 0x6c, 0x69, 0x6e, 0x6b, 0x5f, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74,
	0x6f, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d,
	0x61, 0x2e, 0x4c, 0x69, 0x6e, 0x6b, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x52, 0x0c,
	0x6c, 0x69, 0x6e, 0x6b, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x27, 0x0a, 0x04,
	...
	,
	...
	,
	...
	0x6e, 0x52, 0x03, 0x6e, 0x6f, 0x74, 0x12, 0x36, 0x0a, 0x0c, 0x73, 0x74, 0x72, 0x69, 0x6e, 0x67,
	0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x73,
	0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x4e, 0x6f, 0x64,
	0x65, 0x52, 0x0b, 0x73, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x22, 0xe7,
	0x01, 0x0a, 0x1b, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x43, 0x6f, 0x6d, 0x70, 0x6c,
	0x65, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x56,
	0x0a, 0x18, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x5f, 0x63, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74,
	...
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x44, 0x75,
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x43, 0x0a, 0x0e, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f,
	0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c,
	...
	0x18, 0x03, 0x20, 0x03, 0x28, 0x01, 0x52, 0x10, 0x61, 0x74, 0x74, 0x65, 0x6d, 0x70, 0x74, 0x44,
	0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x9a, 0x03, 0x0a, 0x15, 0x52, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x53, 0x74, 0x61,
	...
	0x79, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x57, 0x0a, 0x0b, 0x61, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x35, 0x2e, 0x73, 0x68, 0x61,
	0x72, 0x65, 0x64, 0x74, 0x79, 0x70, 0x65, 0x73, 0x76, 0x31, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x53, 0x74, 0x61, 0x74, 0x65,
	...
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x53,
	0x74, 0x61, 0x74, 0x65, 0x2e, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79,
	0x52, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x12, 0x2b, 0x0a, 0x06, 0x63, 0x75, 0x73, 0x74,
	0x6f, 0x6d, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d,
	0x61, 0x2e, 0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x4e, 0x6f, 0x64, 0x65, 0x52, 0x06, 0x63,
	0x75, 0x73, 0x74, 0x6f, 0x6d, 0x1a, 0x53, 0x0a, 0x10, 0x41, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74,
	...
	,
	...
	0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x58, 0x0a, 0x0a, 0x61,
	0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x38, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x74, 0x79, 0x70, 0x65, 0x73, 0x76, 0x31, 0x2e,
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62,
	0x75, 0x74, 0x65, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0a, 0x61, 0x74, 0x74, 0x72, 0x69,
	0x62, 0x75, 0x74, 0x65, 0x73, 0x12, 0x3e, 0x0a, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x06,
	...
	,
	...
	0x73, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02,
	0x38, 0x01, 0x22, 0x4f, 0x0a, 0x09, 0x43, 0x61, 0x6e, 0x4c, 0x69, 0x6e, 0x6b, 0x54, 0x6f, 0x12,
	...
	,
	...
	0x0a, 0x05, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e,
	0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x74, 0x79, 0x70, 0x65, 0x73, 0x76, 0x31, 0x2e, 0x44, 0x69,
	0x61, 0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x05, 0x72,
	0x61, 0x6e, 0x67, 0x65, 0x12, 0x3a, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x74, 0x79,
	...
	,
	...
	,
	...
	0x12, 0x43, 0x0a, 0x0e, 0x74, 0x61, 0x67, 0x67, 0x69, 0x6e, 0x67, 0x5f, 0x63, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65,
	0x64, 0x74, 0x79, 0x70, 0x65, 0x73, 0x76, 0x31, 0x2e, 0x54, 0x61, 0x67, 0x67, 0x69, 0x6e, 0x67,
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x0d, 0x74, 0x61, 0x67, 0x67, 0x69, 0x6e, 0x67, 0x43,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x1a, 0x5f, 0x0a, 0x1c, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x58, 0x0a, 0x15, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78,
	...
	,
	...
	,
	...
	0x73, 0x12, 0x67, 0x0a, 0x13, 0x62, 0x6c, 0x75, 0x65, 0x70, 0x72, 0x69, 0x6e, 0x74, 0x5f, 0x76,
	0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x36,
	0x2e, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x74, 0x79, 0x70, 0x65, 0x73, 0x76, 0x31, 0x2e, 0x42,
	0x6c, 0x75, 0x65, 0x70, 0x72, 0x69, 0x6e, 0x74, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x2e, 0x42,
	0x6c, 0x75, 0x65, 0x70, 0x72, 0x69, 0x6e, 0x74, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65,
	0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x12, 0x62, 0x6c, 0x75, 0x65, 0x70, 0x72, 0x69, 0x6e,
	0x74, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x1a, 0x5f, 0x0a, 0x1c, 0x50, 0x72,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x62, 0x0a, 0x1f, 0x54,
	...
	0x58, 0x0a, 0x15, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x5a, 0x0a, 0x17, 0x42, 0x6c, 0x75,
	0x65, 0x70, 0x72, 0x69, 0x6e, 0x74, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x45,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xd9, 0x01, 0x0a, 0x21, 0x4c, 0x69, 0x6e, 0x6b, 0x41, 0x6e,
	0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x61, 0x0a, 0x16, 0x61,
	0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x64, 0x65, 0x66, 0x69, 0x6e, 0x69,
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x73, 0x68,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x48, 0x00, 0x52, 0x15, 0x61, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x45,
	...
	,
	...
	0x31, 0x2e, 0x4c, 0x69, 0x6e, 0x6b, 0x41, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75,
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xf7, 0x02, 0x0a, 0x18, 0x4c, 0x69, 0x6e, 0x6b, 0x41, 0x6e,
	0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69,
	...
	0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x73, 0x68, 0x61,
	0x72, 0x65, 0x64, 0x74, 0x79, 0x70, 0x65, 0x73, 0x76, 0x31, 0x2e, 0x53, 0x63, 0x61, 0x6c, 0x61,
	0x72, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x64,
	0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	...
	,
	...
	,
	...
	,
	...
	0x03, 0x6d, 0x61, 0x78, 0x22, 0x87, 0x01, 0x0a, 0x0d, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2c, 0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x18, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x74, 0x79, 0x70,
	0x65, 0x73, 0x76, 0x31, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x43, 0x6f, 0x64, 0x65, 0x52, 0x04,
	...
	0x66, 0x2e, 0x41, 0x6e, 0x79, 0x52, 0x07, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x22, 0x68,
	0x0a, 0x12, 0x55, 0x6e, 0x61, 0x70, 0x70, 0x6c, 0x69, 0x65, 0x64, 0x4c, 0x69, 0x6e, 0x6b, 0x46,
	0x69, 0x65, 0x6c, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x6c, 0x69, 0x6e, 0x6b, 0x5f, 0x6e, 0x61, 0x6d,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6c, 0x69, 0x6e, 0x6b, 0x4e, 0x61, 0x6d,
	...
	,
	...
	,
	...
	,
...
var file_plugin_framework_sharedtypesv1_types_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
var file_plugin_framework_sharedtypesv1_types_proto_msgTypes = make([]protoimpl.MessageInfo, 107)
var file_plugin_framework_sharedtypesv1_types_proto_goTypes = []any{
	...
	(TaggingSupport)(0),                       // 6: sharedtypesv1.TaggingSupport
	(ErrorCode)(0),                            // 7: sharedtypesv1.ErrorCode
	(*ConfigDefinitionResponse)(nil),          // 8: sharedtypesv1.ConfigDefinitionResponse
	(*ConfigDefinition)(nil),                  // 9: sharedtypesv1.ConfigDefinition
	(*ConfigFieldDefinition)(nil),             // 10: sharedtypesv1.ConfigFieldDefinition
	(*ExamplesResponse)(nil),                  // 11: sharedtypesv1.ExamplesResponse
	(*Examples)(nil),                          // 12: sharedtypesv1.Examples
	(*TypeDescriptionResponse)(nil),           // 13: sharedtypesv1.TypeDescriptionResponse
	(*TypeDescription)(nil),                   // 14: sharedtypesv1.TypeDescription
	(*ResourceTypeResponse)(nil),              // 15: sharedtypesv1.ResourceTypeResponse
	(*ResourceTypeInfo)(nil),                  // 16: sharedtypesv1.ResourceTypeInfo
	(*FunctionDefinitionRequest)(nil),         // 17: sharedtypesv1.FunctionDefinitionRequest
	(*FunctionDefinitionResponse)(nil),        // 18: sharedtypesv1.FunctionDefinitionResponse
	(*FunctionCallRequest)(nil),               // 19: sharedtypesv1.FunctionCallRequest
	(*FunctionCallResponse)(nil),              // 20: sharedtypesv1.FunctionCallResponse
	(*FunctionCallResult)(nil),                // 21: sharedtypesv1.FunctionCallResult
	(*FunctionRuntimeInfo)(nil),               // 22: sharedtypesv1.FunctionRuntimeInfo
	(*FunctionCallArgs)(nil),                  // 23: sharedtypesv1.FunctionCallArgs
	(*FunctionCallContext)(nil),               // 24: sharedtypesv1.FunctionCallContext
	(*FunctionCall)(nil),                      // 25: sharedtypesv1.FunctionCall
	(*SourceMeta)(nil),                        // 26: sharedtypesv1.SourceMeta
	(*SourcePosition)(nil),                    // 27: sharedtypesv1.SourcePosition
	(*FunctionDefinition)(nil),                // 28: sharedtypesv1.FunctionDefinition
	(*FunctionParameter)(nil),                 // 29: sharedtypesv1.FunctionParameter
	(*FunctionScalarParameter)(nil),           // 30: sharedtypesv1.FunctionScalarParameter
	(*FunctionListParameter)(nil),             // 31: sharedtypesv1.FunctionListParameter
	(*FunctionMapParameter)(nil),              // 32: sharedtypesv1.FunctionMapParameter
	(*FunctionObjectParameter)(nil),           // 33: sharedtypesv1.FunctionObjectParameter
	(*FunctionTypeParameter)(nil),             // 34: sharedtypesv1.FunctionTypeParameter
	(*FunctionVariadicParameter)(nil),         // 35: sharedtypesv1.FunctionVariadicParameter
	(*FunctionAnyParameter)(nil),              // 36: sharedtypesv1.FunctionAnyParameter
	(*FunctionReturn)(nil),                    // 37: sharedtypesv1.FunctionReturn
	(*FunctionScalarReturn)(nil),              // 38: sharedtypesv1.FunctionScalarReturn
	(*FunctionListReturn)(nil),                // 39: sharedtypesv1.FunctionListReturn
	(*FunctionMapReturn)(nil),                 // 40: sharedtypesv1.FunctionMapReturn
	(*FunctionObjectReturn)(nil),              // 41: sharedtypesv1.FunctionObjectReturn
	(*FunctionTypeReturn)(nil),                // 42: sharedtypesv1.FunctionTypeReturn
	(*FunctionAnyReturn)(nil),                 // 43: sharedtypesv1.FunctionAnyReturn
	(*FunctionObjectAttributeType)(nil),       // 44: sharedtypesv1.FunctionObjectAttributeType
	(*FunctionValueTypeDefinition)(nil),       // 45: sharedtypesv1.FunctionValueTypeDefinition
	(*FunctionScalarValueTypeDefinition)(nil), // 46: sharedtypesv1.FunctionScalarValueTypeDefinition
	(*FunctionListValueTypeDefinition)(nil),   // 47: sharedtypesv1.FunctionListValueTypeDefinition
	(*FunctionMapValueTypeDefinition)(nil),    // 48: sharedtypesv1.FunctionMapValueTypeDefinition
	(*FunctionObjectValueTypeDefinition)(nil), // 49: sharedtypesv1.FunctionObjectValueTypeDefinition
	(*FunctionTypeValueTypeDefinition)(nil),   // 50: sharedtypesv1.FunctionTypeValueTypeDefinition
	(*FunctionAnyValueTypeDefinition)(nil),    // 51: sharedtypesv1.FunctionAnyValueTypeDefinition
	(*DeployResourceRequest)(nil),             // 52: sharedtypesv1.DeployResourceRequest
	(*DeployResourceResponse)(nil),            // 53: sharedtypesv1.DeployResourceResponse
	(*DeployResourceCompleteResponse)(nil),    // 54: sharedtypesv1.DeployResourceCompleteResponse
	(*ResourceHasStabilisedRequest)(nil),      // 55: sharedtypesv1.ResourceHasStabilisedRequest
	(*ResourceHasStabilisedResponse)(nil),     // 56: sharedtypesv1.ResourceHasStabilisedResponse
	(*DestroyResourceRequest)(nil),            // 57: sharedtypesv1.DestroyResourceRequest
	(*DestroyResourceResponse)(nil),           // 58: sharedtypesv1.DestroyResourceResponse
	(*DestroyResourceResult)(nil),             // 59: sharedtypesv1.DestroyResourceResult
	(*ResourceStabilisationInfo)(nil),         // 60: sharedtypesv1.ResourceStabilisationInfo
	(*Changes)(nil),                           // 61: sharedtypesv1.Changes
	(*FieldChange)(nil),                       // 62: sharedtypesv1.FieldChange
	(*LinkChanges)(nil),                       // 63: sharedtypesv1.LinkChanges
	(*ResourceInfo)(nil),                      // 64: sharedtypesv1.ResourceInfo
	(*ResourceState)(nil),                     // 65: sharedtypesv1.ResourceState
	(*ResolvedResource)(nil),                  // 66: sharedtypesv1.ResolvedResource
	(*ResolvedResourceMetadata)(nil),          // 67: sharedtypesv1.ResolvedResourceMetadata
	(*ResolvedResourceCondition)(nil),         // 68: sharedtypesv1.ResolvedResourceCondition
	(*ResourceCompletionDurations)(nil),       // 69: sharedtypesv1.ResourceCompletionDurations
	(*ResourceMetadataState)(nil),             // 70: sharedtypesv1.ResourceMetadataState
	(*SystemMetadataState)(nil),               // 71: sharedtypesv1.SystemMetadataState
	(*ProvenanceState)(nil),                   // 72: sharedtypesv1.ProvenanceState
	(*ResourceSpecDefinition)(nil),            // 73: sharedtypesv1.ResourceSpecDefinition
	(*ResourceDefinitionsSchema)(nil),         // 74: sharedtypesv1.ResourceDefinitionsSchema
	(*CanLinkTo)(nil),                         // 75: sharedtypesv1.CanLinkTo
	(*ResourceCommonTerminalInfo)(nil),        // 76: sharedtypesv1.ResourceCommonTerminalInfo
	(*Diagnostic)(nil),                        // 77: sharedtypesv1.Diagnostic
	(*DiagnosticContext)(nil),                 // 78: sharedtypesv1.DiagnosticContext
	(*DiagnosticSuggestedAction)(nil),         // 79: sharedtypesv1.DiagnosticSuggestedAction
	(*DiagnosticRange)(nil),                   // 80: sharedtypesv1.DiagnosticRange
	(*ResourceType)(nil),                      // 81: sharedtypesv1.ResourceType
	(*ProviderContext)(nil),                   // 82: sharedtypesv1.ProviderContext
	(*TaggingConfig)(nil),                     // 83: sharedtypesv1.TaggingConfig
	(*BlueprintParams)(nil),                   // 84: sharedtypesv1.BlueprintParams
	(*LinkAnnotationDefinitionsResponse)(nil), // 85: sharedtypesv1.LinkAnnotationDefinitionsResponse
	(*LinkAnnotationDefinitions)(nil),         // 86: sharedtypesv1.LinkAnnotationDefinitions
	(*LinkAnnotationDefinition)(nil),          // 87: sharedtypesv1.LinkAnnotationDefinition
	(*LinkCardinalityResponse)(nil),           // 88: sharedtypesv1.LinkCardinalityResponse
	(*LinkCardinalityInfo)(nil),               // 89: sharedtypesv1.LinkCardinalityInfo
	(*LinkCapabilitiesResponse)(nil),          // 90: sharedtypesv1.LinkCapabilitiesResponse
	(*LinkCapabilitiesInfo)(nil),              // 91: sharedtypesv1.LinkCapabilitiesInfo
	(*LinkCapability)(nil),                    // 92: sharedtypesv1.LinkCapability
	(*LinkItemCardinality)(nil),               // 93: sharedtypesv1.LinkItemCardinality
	(*ErrorResponse)(nil),                     // 94: sharedtypesv1.ErrorResponse
	(*UnappliedLinkField)(nil),                // 95: sharedtypesv1.UnappliedLinkField
	nil,                                       // 96: sharedtypesv1.ConfigDefinition.FieldsEntry
	nil,                                       // 97: sharedtypesv1.FunctionObjectValueTypeDefinition.AttributeTypesEntry
	nil,                                       // 98: sharedtypesv1.DeployResourceCompleteResponse.ComputedFieldValuesEntry
	nil,                                       // 99: sharedtypesv1.ResourceStabilisationInfo.ComputedFieldValuesEntry
	nil,                                       // 100: sharedtypesv1.Changes.NewOutboundLinksEntry
	nil,                                       // 101: sharedtypesv1.Changes.OutboundLinkChangesEntry
	nil,                                       // 102: sharedtypesv1.Changes.LinkOwnedFieldsEntry
	nil,                                       // 103: sharedtypesv1.LinkChanges.ResourceDataMappingsEntry
	nil,                                       // 104: sharedtypesv1.ResolvedResourceMetadata.LabelsEntry
	nil,                                       // 105: sharedtypesv1.ResourceMetadataState.AnnotationsEntry
	nil,                                       // 106: sharedtypesv1.ResourceMetadataState.LabelsEntry
	nil,                                       // 107: sharedtypesv1.ResourceDefinitionsSchema.AttributesEntry
	nil,                                       // 108: sharedtypesv1.ProviderContext.ProviderConfigVariablesEntry
	nil,                                       // 109: sharedtypesv1.ProviderContext.ContextVariablesEntry
	nil,                                       // 110: sharedtypesv1.BlueprintParams.ProviderConfigVariablesEntry
	nil,                                       // 111: sharedtypesv1.BlueprintParams.TransformerConfigVariablesEntry
	nil,                                       // 112: sharedtypesv1.BlueprintParams.ContextVariablesEntry
	nil,                                       // 113: sharedtypesv1.BlueprintParams.BlueprintVariablesEntry
	nil,                                       // 114: sharedtypesv1.LinkAnnotationDefinitions.DefinitionsEntry
	(*schemapb.ScalarValue)(nil),              // 115: schema.ScalarValue
	(*anypb.Any)(nil),                         // 116: google.protobuf.Any
	(*schemapb.MappingNode)(nil),              // 117: schema.MappingNode
	(*wrapperspb.Int64Value)(nil),             // 118: google.protobuf.Int64Value
	(*schemapb.LinkSelector)(nil),             // 119: schema.LinkSelector
...
var file_plugin_framework_sharedtypesv1_types_proto_depIdxs = []int32{
	9,   // 0: sharedtypesv1.ConfigDefinitionResponse.config_definition:type_name -> sharedtypesv1.ConfigDefinition
	94,  // 1: sharedtypesv1.ConfigDefinitionResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	96,  // 2: sharedtypesv1.ConfigDefinition.fields:type_name -> sharedtypesv1.ConfigDefinition.FieldsEntry
	0,   // 3: sharedtypesv1.ConfigFieldDefinition.type:type_name -> sharedtypesv1.ScalarType
	115, // 4: sharedtypesv1.ConfigFieldDefinition.default_value:type_name -> schema.ScalarValue
	115, // 5: sharedtypesv1.ConfigFieldDefinition.allowed_values:type_name -> schema.ScalarValue
	115, // 6: sharedtypesv1.ConfigFieldDefinition.examples:type_name -> schema.ScalarValue
	12,  // 7: sharedtypesv1.ExamplesResponse.examples:type_name -> sharedtypesv1.Examples
	94,  // 8: sharedtypesv1.ExamplesResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	14,  // 9: sharedtypesv1.TypeDescriptionResponse.description:type_name -> sharedtypesv1.TypeDescription
	94,  // 10: sharedtypesv1.TypeDescriptionResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	16,  // 11: sharedtypesv1.ResourceTypeResponse.resource_type_info:type_name -> sharedtypesv1.ResourceTypeInfo
	94,  // 12: sharedtypesv1.ResourceTypeResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	81,  // 13: sharedtypesv1.ResourceTypeInfo.type:type_name -> sharedtypesv1.ResourceType
	84,  // 14: sharedtypesv1.FunctionDefinitionRequest.params:type_name -> sharedtypesv1.BlueprintParams
	28,  // 15: sharedtypesv1.FunctionDefinitionResponse.function_definition:type_name -> sharedtypesv1.FunctionDefinition
	94,  // 16: sharedtypesv1.FunctionDefinitionResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	23,  // 17: sharedtypesv1.FunctionCallRequest.args:type_name -> sharedtypesv1.FunctionCallArgs
	24,  // 18: sharedtypesv1.FunctionCallRequest.call_context:type_name -> sharedtypesv1.FunctionCallContext
	21,  // 19: sharedtypesv1.FunctionCallResponse.function_result:type_name -> sharedtypesv1.FunctionCallResult
	94,  // 20: sharedtypesv1.FunctionCallResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	116, // 21: sharedtypesv1.FunctionCallResult.response_data:type_name -> google.protobuf.Any
	22,  // 22: sharedtypesv1.FunctionCallResult.function_info:type_name -> sharedtypesv1.FunctionRuntimeInfo
	116, // 23: sharedtypesv1.FunctionRuntimeInfo.partial_args:type_name -> google.protobuf.Any
	116, // 24: sharedtypesv1.FunctionCallArgs.args:type_name -> google.protobuf.Any
	84,  // 25: sharedtypesv1.FunctionCallContext.params:type_name -> sharedtypesv1.BlueprintParams
	25,  // 26: sharedtypesv1.FunctionCallContext.call_stack:type_name -> sharedtypesv1.FunctionCall
	26,  // 27: sharedtypesv1.FunctionCallContext.current_location:type_name -> sharedtypesv1.SourceMeta
	26,  // 28: sharedtypesv1.FunctionCall.location:type_name -> sharedtypesv1.SourceMeta
	27,  // 29: sharedtypesv1.SourceMeta.start_position:type_name -> sharedtypesv1.SourcePosition
	27,  // 30: sharedtypesv1.SourceMeta.end_position:type_name -> sharedtypesv1.SourcePosition
	29,  // 31: sharedtypesv1.FunctionDefinition.parameters:type_name -> sharedtypesv1.FunctionParameter
	37,  // 32: sharedtypesv1.FunctionDefinition.return:type_name -> sharedtypesv1.FunctionReturn
	30,  // 33: sharedtypesv1.FunctionParameter.scalar_parameter:type_name -> sharedtypesv1.FunctionScalarParameter
	31,  // 34: sharedtypesv1.FunctionParameter.list_parameter:type_name -> sharedtypesv1.FunctionListParameter
	32,  // 35: sharedtypesv1.FunctionParameter.map_parameter:type_name -> sharedtypesv1.FunctionMapParameter
	33,  // 36: sharedtypesv1.FunctionParameter.object_parameter:type_name -> sharedtypesv1.FunctionObjectParameter
	34,  // 37: sharedtypesv1.FunctionParameter.function_type_parameter:type_name -> sharedtypesv1.FunctionTypeParameter
	35,  // 38: sharedtypesv1.FunctionParameter.variadic_parameter:type_name -> sharedtypesv1.FunctionVariadicParameter
	36,  // 39: sharedtypesv1.FunctionParameter.any_parameter:type_name -> sharedtypesv1.FunctionAnyParameter
	45,  // 40: sharedtypesv1.FunctionScalarParameter.type:type_name -> sharedtypesv1.FunctionValueTypeDefinition
	45,  // 41: sharedtypesv1.FunctionListParameter.element_type:type_name -> sharedtypesv1.FunctionValueTypeDefinition
	45,  // 42: sharedtypesv1.FunctionMapParameter.element_type:type_name -> sharedtypesv1.FunctionValueTypeDefinition
	45,  // 43: sharedtypesv1.FunctionObjectParameter.object_value_type:type_name -> sharedtypesv1.FunctionValueTypeDefinition
	45,  // 44: sharedtypesv1.FunctionTypeParameter.function_type:type_name -> sharedtypesv1.FunctionValueTypeDefinition
	45,  // 45: sharedtypesv1.FunctionVariadicParameter.type:type_name -> sharedtypesv1.FunctionValueTypeDefinition
	45,  // 46: sharedtypesv1.FunctionAnyParameter.union_types:type_name -> sharedtypesv1.FunctionValueTypeDefinition
	38,  // 47: sharedtypesv1.FunctionReturn.scalar_return:type_name -> sharedtypesv1.FunctionScalarReturn
	39,  // 48: sharedtypesv1.FunctionReturn.list_return:type_name -> sharedtypesv1.FunctionListReturn
	40,  // 49: sharedtypesv1.FunctionReturn.map_return:type_name -> sharedtypesv1.FunctionMapReturn
	41,  // 50: sharedtypesv1.FunctionReturn.object_return:type_name -> sharedtypesv1.FunctionObjectReturn
	42,  // 51: sharedtypesv1.FunctionReturn.function_type_return:type_name -> sharedtypesv1.FunctionTypeReturn
	43,  // 52: sharedtypesv1.FunctionReturn.any_return:type_name -> sharedtypesv1.FunctionAnyReturn
	45,  // 53: sharedtypesv1.FunctionScalarReturn.type:type_name -> sharedtypesv1.FunctionValueTypeDefinition
	45,  // 54: sharedtypesv1.FunctionListReturn.element_type:type_name -> sharedtypesv1.FunctionValueTypeDefinition
	45,  // 55: sharedtypesv1.FunctionMapReturn.element_type:type_name -> sharedtypesv1.FunctionValueTypeDefinition
	45,  // 56: sharedtypesv1.FunctionObjectReturn.object_value_type:type_name -> sharedtypesv1.FunctionValueTypeDefinition
	45,  // 57: sharedtypesv1.FunctionTypeReturn.function_type:type_name -> sharedtypesv1.FunctionValueTypeDefinition
	1,   // 58: sharedtypesv1.FunctionAnyReturn.type:type_name -> sharedtypesv1.FunctionValueType
	45,  // 59: sharedtypesv1.FunctionAnyReturn.union_types:type_name -> sharedtypesv1.FunctionValueTypeDefinition
	45,  // 60: sharedtypesv1.FunctionObjectAttributeType.type:type_name -> sharedtypesv1.FunctionValueTypeDefinition
	46,  // 61: sharedtypesv1.FunctionValueTypeDefinition.scalar_value_type:type_name -> sharedtypesv1.FunctionScalarValueTypeDefinition
	47,  // 62: sharedtypesv1.FunctionValueTypeDefinition.list_value_type:type_name -> sharedtypesv1.FunctionListValueTypeDefinition
	48,  // 63: sharedtypesv1.FunctionValueTypeDefinition.map_value_type:type_name -> sharedtypesv1.FunctionMapValueTypeDefinition
	49,  // 64: sharedtypesv1.FunctionValueTypeDefinition.object_value_type:type_name -> sharedtypesv1.FunctionObjectValueTypeDefinition
	50,  // 65: sharedtypesv1.FunctionValueTypeDefinition.function_value_type:type_name -> sharedtypesv1.FunctionTypeValueTypeDefinition
	51,  // 66: sharedtypesv1.FunctionValueTypeDefinition.any_value_type:type_name -> sharedtypesv1.FunctionAnyValueTypeDefinition
	1,   // 67: sharedtypesv1.FunctionScalarValueTypeDefinition.type:type_name -> sharedtypesv1.FunctionValueType
	45,  // 68: sharedtypesv1.FunctionListValueTypeDefinition.element_type:type_name -> sharedtypesv1.FunctionValueTypeDefinition
	45,  // 69: sharedtypesv1.FunctionMapValueTypeDefinition.element_type:type_name -> sharedtypesv1.FunctionValueTypeDefinition
	97,  // 70: sharedtypesv1.FunctionObjectValueTypeDefinition.attribute_types:type_name -> sharedtypesv1.FunctionObjectValueTypeDefinition.AttributeTypesEntry
	28,  // 71: sharedtypesv1.FunctionTypeValueTypeDefinition.function_type:type_name -> sharedtypesv1.FunctionDefinition
	1,   // 72: sharedtypesv1.FunctionAnyValueTypeDefinition.type:type_name -> sharedtypesv1.FunctionValueType
	45,  // 73: sharedtypesv1.FunctionAnyValueTypeDefinition.union_types:type_name -> sharedtypesv1.FunctionValueTypeDefinition
	81,  // 74: sharedtypesv1.DeployResourceRequest.resource_type:type_name -> sharedtypesv1.ResourceType
	61,  // 75: sharedtypesv1.DeployResourceRequest.changes:type_name -> sharedtypesv1.Changes
	82,  // 76: sharedtypesv1.DeployResourceRequest.context:type_name -> sharedtypesv1.ProviderContext
	54,  // 77: sharedtypesv1.DeployResourceResponse.complete_response:type_name -> sharedtypesv1.DeployResourceCompleteResponse
	94,  // 78: sharedtypesv1.DeployResourceResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	98,  // 79: sharedtypesv1.DeployResourceCompleteResponse.computed_field_values:type_name -> sharedtypesv1.DeployResourceCompleteResponse.ComputedFieldValuesEntry
	81,  // 80: sharedtypesv1.ResourceHasStabilisedRequest.resource_type:type_name -> sharedtypesv1.ResourceType
	117, // 81: sharedtypesv1.ResourceHasStabilisedRequest.resource_spec:type_name -> schema.MappingNode
	70,  // 82: sharedtypesv1.ResourceHasStabilisedRequest.resource_metadata:type_name -> sharedtypesv1.ResourceMetadataState
	82,  // 83: sharedtypesv1.ResourceHasStabilisedRequest.context:type_name -> sharedtypesv1.ProviderContext
	60,  // 84: sharedtypesv1.ResourceHasStabilisedResponse.resource_stabilisation_info:type_name -> sharedtypesv1.ResourceStabilisationInfo
	94,  // 85: sharedtypesv1.ResourceHasStabilisedResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	81,  // 86: sharedtypesv1.DestroyResourceRequest.resource_type:type_name -> sharedtypesv1.ResourceType
	65,  // 87: sharedtypesv1.DestroyResourceRequest.resource_state:type_name -> sharedtypesv1.ResourceState
	82,  // 88: sharedtypesv1.DestroyResourceRequest.context:type_name -> sharedtypesv1.ProviderContext
	59,  // 89: sharedtypesv1.DestroyResourceResponse.result:type_name -> sharedtypesv1.DestroyResourceResult
	94,  // 90: sharedtypesv1.DestroyResourceResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	99,  // 91: sharedtypesv1.ResourceStabilisationInfo.computed_field_values:type_name -> sharedtypesv1.ResourceStabilisationInfo.ComputedFieldValuesEntry
	64,  // 92: sharedtypesv1.Changes.applied_resource_info:type_name -> sharedtypesv1.ResourceInfo
	62,  // 93: sharedtypesv1.Changes.modified_fields:type_name -> sharedtypesv1.FieldChange
	62,  // 94: sharedtypesv1.Changes.new_fields:type_name -> sharedtypesv1.FieldChange
	100, // 95: sharedtypesv1.Changes.new_outbound_links:type_name -> sharedtypesv1.Changes.NewOutboundLinksEntry
	101, // 96: sharedtypesv1.Changes.outbound_link_changes:type_name -> sharedtypesv1.Changes.OutboundLinkChangesEntry
	102, // 97: sharedtypesv1.Changes.link_owned_fields:type_name -> sharedtypesv1.Changes.LinkOwnedFieldsEntry
	95,  // 98: sharedtypesv1.Changes.unapplied_link_fields:type_name -> sharedtypesv1.UnappliedLinkField
	117, // 99: sharedtypesv1.FieldChange.prev_value:type_name -> schema.MappingNode
	117, // 100: sharedtypesv1.FieldChange.new_value:type_name -> schema.MappingNode
	62,  // 101: sharedtypesv1.LinkChanges.modified_fields:type_name -> sharedtypesv1.FieldChange
	62,  // 102: sharedtypesv1.LinkChanges.new_fields:type_name -> sharedtypesv1.FieldChange
	103, // 103: sharedtypesv1.LinkChanges.resource_data_mappings:type_name -> sharedtypesv1.LinkChanges.ResourceDataMappingsEntry
	65,  // 104: sharedtypesv1.ResourceInfo.current_resource_state:type_name -> sharedtypesv1.ResourceState
	66,  // 105: sharedtypesv1.ResourceInfo.resource_with_resolved_subs:type_name -> sharedtypesv1.ResolvedResource
	2,   // 106: sharedtypesv1.ResourceState.status:type_name -> sharedtypesv1.ResourceStatus
	3,   // 107: sharedtypesv1.ResourceState.precise_status:type_name -> sharedtypesv1.PreciseResourceStatus
	117, // 108: sharedtypesv1.ResourceState.spec_data:type_name -> schema.MappingNode
	70,  // 109: sharedtypesv1.ResourceState.metadata:type_name -> sharedtypesv1.ResourceMetadataState
	118, // 110: sharedtypesv1.ResourceState.last_drift_detected_timestamp:type_name -> google.protobuf.Int64Value
	69,  // 111: sharedtypesv1.ResourceState.durations:type_name -> sharedtypesv1.ResourceCompletionDurations
	71,  // 112: sharedtypesv1.ResourceState.system_metadata:type_name -> sharedtypesv1.SystemMetadataState
	81,  // 113: sharedtypesv1.ResolvedResource.type:type_name -> sharedtypesv1.ResourceType
	117, // 114: sharedtypesv1.ResolvedResource.description:type_name -> schema.MappingNode
	67,  // 115: sharedtypesv1.ResolvedResource.metadata:type_name -> sharedtypesv1.ResolvedResourceMetadata
	68,  // 116: sharedtypesv1.ResolvedResource.condition:type_name -> sharedtypesv1.ResolvedResourceCondition
	119, // 117: sharedtypesv1.ResolvedResource.link_selector:type_name -> schema.LinkSelector
	117, // 118: sharedtypesv1.ResolvedResource.spec:type_name -> schema.MappingNode
	117, // 119: sharedtypesv1.ResolvedResourceMetadata.display_name:type_name -> schema.MappingNode
	117, // 120: sharedtypesv1.ResolvedResourceMetadata.annotations:type_name -> schema.MappingNode
	104, // 121: sharedtypesv1.ResolvedResourceMetadata.labels:type_name -> sharedtypesv1.ResolvedResourceMetadata.LabelsEntry
	117, // 122: sharedtypesv1.ResolvedResourceMetadata.custom:type_name -> schema.MappingNode
	68,  // 123: sharedtypesv1.ResolvedResourceCondition.and:type_name -> sharedtypesv1.ResolvedResourceCondition
	68,  // 124: sharedtypesv1.ResolvedResourceCondition.or:type_name -> sharedtypesv1.ResolvedResourceCondition
	68,  // 125: sharedtypesv1.ResolvedResourceCondition.not:type_name -> sharedtypesv1.ResolvedResourceCondition
	117, // 126: sharedtypesv1.ResolvedResourceCondition.string_value:type_name -> schema.MappingNode
	120, // 127: sharedtypesv1.ResourceCompletionDurations.config_complete_duration:type_name -> google.protobuf.DoubleValue
	120, // 128: sharedtypesv1.ResourceCompletionDurations.total_duration:type_name -> google.protobuf.DoubleValue
	105, // 129: sharedtypesv1.ResourceMetadataState.annotations:type_name -> sharedtypesv1.ResourceMetadataState.AnnotationsEntry
	106, // 130: sharedtypesv1.ResourceMetadataState.labels:type_name -> sharedtypesv1.ResourceMetadataState.LabelsEntry
	117, // 131: sharedtypesv1.ResourceMetadataState.custom:type_name -> schema.MappingNode
	72,  // 132: sharedtypesv1.SystemMetadataState.provenance:type_name -> sharedtypesv1.ProvenanceState
	74,  // 133: sharedtypesv1.ResourceSpecDefinition.schema:type_name -> sharedtypesv1.ResourceDefinitionsSchema
	6,   // 134: sharedtypesv1.ResourceSpecDefinition.tagging_support:type_name -> sharedtypesv1.TaggingSupport
	107, // 135: sharedtypesv1.ResourceDefinitionsSchema.attributes:type_name -> sharedtypesv1.ResourceDefinitionsSchema.AttributesEntry
	74,  // 136: sharedtypesv1.ResourceDefinitionsSchema.items:type_name -> sharedtypesv1.ResourceDefinitionsSchema
	74,  // 137: sharedtypesv1.ResourceDefinitionsSchema.map_values:type_name -> sharedtypesv1.ResourceDefinitionsSchema
	74,  // 138: sharedtypesv1.ResourceDefinitionsSchema.one_of:type_name -> sharedtypesv1.ResourceDefinitionsSchema
	117, // 139: sharedtypesv1.ResourceDefinitionsSchema.default_value:type_name -> schema.MappingNode
	117, // 140: sharedtypesv1.ResourceDefinitionsSchema.examples:type_name -> schema.MappingNode
	117, // 141: sharedtypesv1.ResourceDefinitionsSchema.allowed_values:type_name -> schema.MappingNode
	115, // 142: sharedtypesv1.ResourceDefinitionsSchema.minimum:type_name -> schema.ScalarValue
	115, // 143: sharedtypesv1.ResourceDefinitionsSchema.maximum:type_name -> schema.ScalarValue
	81,  // 144: sharedtypesv1.CanLinkTo.resource_types:type_name -> sharedtypesv1.ResourceType
	4,   // 145: sharedtypesv1.Diagnostic.level:type_name -> sharedtypesv1.DiagnosticLevel
	80,  // 146: sharedtypesv1.Diagnostic.range:type_name -> sharedtypesv1.DiagnosticRange
	78,  // 147: sharedtypesv1.Diagnostic.context:type_name -> sharedtypesv1.DiagnosticContext
	79,  // 148: sharedtypesv1.DiagnosticContext.suggested_actions:type_name -> sharedtypesv1.DiagnosticSuggestedAction
	116, // 149: sharedtypesv1.DiagnosticContext.metadata:type_name -> google.protobuf.Any
	26,  // 150: sharedtypesv1.DiagnosticRange.start:type_name -> sharedtypesv1.SourceMeta
	26,  // 151: sharedtypesv1.DiagnosticRange.end:type_name -> sharedtypesv1.SourceMeta
	5,   // 152: sharedtypesv1.DiagnosticRange.column_accuracy:type_name -> sharedtypesv1.ColumnAccuracy
	108, // 153: sharedtypesv1.ProviderContext.provider_config_variables:type_name -> sharedtypesv1.ProviderContext.ProviderConfigVariablesEntry
	109, // 154: sharedtypesv1.ProviderContext.context_variables:type_name -> sharedtypesv1.ProviderContext.ContextVariablesEntry
	83,  // 155: sharedtypesv1.ProviderContext.tagging_config:type_name -> sharedtypesv1.TaggingConfig
	110, // 156: sharedtypesv1.BlueprintParams.provider_config_variables:type_name -> sharedtypesv1.BlueprintParams.ProviderConfigVariablesEntry
	111, // 157: sharedtypesv1.BlueprintParams.transformer_config_variables:type_name -> sharedtypesv1.BlueprintParams.TransformerConfigVariablesEntry
	112, // 158: sharedtypesv1.BlueprintParams.context_variables:type_name -> sharedtypesv1.BlueprintParams.ContextVariablesEntry
	113, // 159: sharedtypesv1.BlueprintParams.blueprint_variables:type_name -> sharedtypesv1.BlueprintParams.BlueprintVariablesEntry
	86,  // 160: sharedtypesv1.LinkAnnotationDefinitionsResponse.annotation_definitions:type_name -> sharedtypesv1.LinkAnnotationDefinitions
	94,  // 161: sharedtypesv1.LinkAnnotationDefinitionsResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	114, // 162: sharedtypesv1.LinkAnnotationDefinitions.definitions:type_name -> sharedtypesv1.LinkAnnotationDefinitions.DefinitionsEntry
	0,   // 163: sharedtypesv1.LinkAnnotationDefinition.type:type_name -> sharedtypesv1.ScalarType
	115, // 164: sharedtypesv1.LinkAnnotationDefinition.default_value:type_name -> schema.ScalarValue
	115, // 165: sharedtypesv1.LinkAnnotationDefinition.allowed_values:type_name -> schema.ScalarValue
	115, // 166: sharedtypesv1.LinkAnnotationDefinition.examples:type_name -> schema.ScalarValue
	89,  // 167: sharedtypesv1.LinkCardinalityResponse.cardinality_info:type_name -> sharedtypesv1.LinkCardinalityInfo
	94,  // 168: sharedtypesv1.LinkCardinalityResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	93,  // 169: sharedtypesv1.LinkCardinalityInfo.cardinality_a:type_name -> sharedtypesv1.LinkItemCardinality
	93,  // 170: sharedtypesv1.LinkCardinalityInfo.cardinality_b:type_name -> sharedtypesv1.LinkItemCardinality
	91,  // 171: sharedtypesv1.LinkCapabilitiesResponse.capabilities_info:type_name -> sharedtypesv1.LinkCapabilitiesInfo
	94,  // 172: sharedtypesv1.LinkCapabilitiesResponse.error_response:type_name -> sharedtypesv1.ErrorResponse
	92,  // 173: sharedtypesv1.LinkCapabilitiesInfo.provides:type_name -> sharedtypesv1.LinkCapability
	92,  // 174: sharedtypesv1.LinkCapabilitiesInfo.requires:type_name -> sharedtypesv1.LinkCapability
	7,   // 175: sharedtypesv1.ErrorResponse.code:type_name -> sharedtypesv1.ErrorCode
	116, // 176: sharedtypesv1.ErrorResponse.details:type_name -> google.protobuf.Any
	10,  // 177: sharedtypesv1.ConfigDefinition.FieldsEntry.value:type_name -> sharedtypesv1.ConfigFieldDefinition
	44,  // 178: sharedtypesv1.FunctionObjectValueTypeDefinition.AttributeTypesEntry.value:type_name -> sharedtypesv1.FunctionObjectAttributeType
	117, // 179: sharedtypesv1.DeployResourceCompleteResponse.ComputedFieldValuesEntry.value:type_name -> schema.MappingNode
	117, // 180: sharedtypesv1.ResourceStabilisationInfo.ComputedFieldValuesEntry.value:type_name -> schema.MappingNode
	63,  // 181: sharedtypesv1.Changes.NewOutboundLinksEntry.value:type_name -> sharedtypesv1.LinkChanges
	63,  // 182: sharedtypesv1.Changes.OutboundLinkChangesEntry.value:type_name -> sharedtypesv1.LinkChanges
	117, // 183: sharedtypesv1.ResourceMetadataState.AnnotationsEntry.value:type_name -> schema.MappingNode
	74,  // 184: sharedtypesv1.ResourceDefinitionsSchema.AttributesEntry.value:type_name -> sharedtypesv1.ResourceDefinitionsSchema
	115, // 185: sharedtypesv1.ProviderContext.ProviderConfigVariablesEntry.value:type_name -> schema.ScalarValue
	115, // 186: sharedtypesv1.ProviderContext.ContextVariablesEntry.value:type_name -> schema.ScalarValue
	115, // 187: sharedtypesv1.BlueprintParams.ProviderConfigVariablesEntry.value:type_name -> schema.ScalarValue
	115, // 188: sharedtypesv1.BlueprintParams.TransformerConfigVariablesEntry.value:type_name -> schema.ScalarValue
	115, // 189: sharedtypesv1.BlueprintParams.ContextVariablesEntry.value:type_name -> schema.ScalarValue
	115, // 190: sharedtypesv1.BlueprintParams.BlueprintVariablesEntry.value:type_name -> schema.ScalarValue
	87,  // 191: sharedtypesv1.LinkAnnotationDefinitions.DefinitionsEntry.value:type_name -> sharedtypesv1.LinkAnnotationDefinition
...
func file_plugin_framework_sharedtypesv1_types_proto_init() {
	...
	file_plugin_framework_sharedtypesv1_types_proto_msgTypes[77].OneofWrappers = []any{
		(*LinkAnnotationDefinitionsResponse_AnnotationDefinitions)(nil),
		(*LinkAnnotationDefinitionsResponse_ErrorResponse)(nil),
	}
	file_plugin_framework_sharedtypesv1_types_proto_msgTypes[80].OneofWrappers = []any{
		(*LinkCardinalityResponse_CardinalityInfo)(nil),
		(*LinkCardinalityResponse_ErrorResponse)(nil),
	}
	file_plugin_framework_sharedtypesv1_types_proto_msgTypes[82].OneofWrappers = []any{
		(*LinkCapabilitiesResponse_CapabilitiesInfo)(nil),
		(*LinkCapabilitiesResponse_ErrorResponse)(nil),
	}
	type x struct{}
