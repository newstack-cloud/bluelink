...
require (
	...
	github.com/newstack-cloud/deploy-cli-sdk v0.3.1
...
require (
	...
	github.com/newstack-cloud/bluelink/libs/blueprint v0.44.0 // indirect
	github.com/newstack-cloud/bluelink/libs/blueprint-state v0.8.2 // indirect
	github.com/newstack-cloud/bluelink/libs/common v0.4.0 // indirect
	github.com/newstack-cloud/bluelink/libs/deploy-engine-client v0.4.3 // indirect
