...
require (
	...
	github.com/newstack-cloud/deploy-cli-sdk v0.3.0
...
require (
	...
	github.com/newstack-cloud/bluelink/libs/blueprint v0.43.0 // indirect
	github.com/newstack-cloud/bluelink/libs/blueprint-state v0.7.0 // indirect
	github.com/newstack-cloud/bluelink/libs/common v0.4.0 // indirect
	github.com/newstack-cloud/bluelink/libs/deploy-engine-client v0.4.0 // indirect
