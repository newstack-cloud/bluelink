...
require (
	...
	github.com/newstack-cloud/deploy-cli-sdk v0.5.0
...
require (
	...
	github.com/newstack-cloud/bluelink/libs/blueprint v0.47.0 // indirect
	...
	github.com/newstack-cloud/bluelink/libs/deploy-engine-client v0.5.0 // indirect
